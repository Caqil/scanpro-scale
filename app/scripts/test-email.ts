...
async function testEmailSending() {
  ...
  try {
    await sendEmail({
      to: recipientEmail,
      subject: 'MegaPDF Email Configuration Test',
      text: 'This is a test email to verify your MegaPDF email configuration is working correctly.',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background-color: #FFEAA0; padding: 20px; text-align: center;">
            <h1 style="margin: 0; color: #1A2238;">MegaPDF</h1>
          </div>
          <div style="padding: 20px; border: 1px solid #e1e1e1; border-top: none;">
            <h2>Email Configuration Test</h2>
            <p>This is a test email to verify your MegaPDF email configuration is working correctly.</p>
          ...
          <div style="text-align: center; padding: 20px; font-size: 12px; color: #666;">
            <p>© 2025 MegaPDF. All rights reserved.</p>
          </div>
        </div>
      `
    });
