...
export async function generateMetadata({
  ...
  const lang = SUPPORTED_LANGUAGES.includes(paramLang as Language)
  ...
  const extractKeywords = (text: string, language: string): string[] => {
    ...
    const stopWords =
      stopWordsByLanguage[language] || stopWordsByLanguage["en"];
  ...
  return {
    title:
      t("about.hero.title") ||
      "About MegaPDF | Transforming Document Management",
    description:
      t("about.description") ||
      "Learn about MegaPDF's mission to simplify digital document management with cutting-edge PDF tools.",
    openGraph: {
      title:
        t("about.hero.title") ||
        "About MegaPDF | Transforming Document Management",
