    ...
    <div className="container max-w-6xl mx-auto py-12 px-4">
      ...
      <section className="text-center mb-16">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          {t("about.hero.description") ||
            "MegaPDF was born from a simple idea: making document management seamless, efficient, and accessible to everyone. We believe in transforming how people interact with digital documents."}
        </p>
      </section>
        ...
        <div>
          ...
          <p className="text-muted-foreground mb-4">
            {t("about.story.paragraph1") ||
              "Founded in 2022, MegaPDF emerged from the frustration of dealing with complex and unintuitive PDF tools. Our founders, tech enthusiasts and document management experts, saw an opportunity to create a solution that was both powerful and user-friendly."}
          </p>
          <p className="text-muted-foreground">
            {t("about.story.paragraph2") ||
              "What started as a small project quickly grew into a comprehensive platform serving thousands of users worldwide, from students and professionals to large enterprises."}
          </p>
        </div>
      ...
      <section className="mb-16">
        <h2 className="text-3xl font-bold text-center mb-12">
          {t("about.missionValues.title") || "Our Mission and Values"}
        </h2>
        <div className="grid md:grid-cols-3 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardTitle>
                {t("about.missionValues.mission.title") || "Mission"}
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                {t("about.missionValues.mission.description") ||
                  "To simplify digital document management by providing intuitive, powerful, and accessible PDF tools that enhance productivity and creativity."}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardTitle>
                {t("about.missionValues.customerFirst.title") ||
                  "Customer First"}
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                {t("about.missionValues.customerFirst.description") ||
                  "We prioritize user experience and continuously improve our tools based on real user feedback. Your needs drive our innovation."}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardTitle>
                {t("about.missionValues.privacy.title") || "Privacy & Security"}
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                {t("about.missionValues.privacy.description") ||
                  "We are committed to protecting your data with state-of-the-art security measures and absolute respect for your privacy."}
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-semibold mb-2">
              {t("about.coreValues.innovation.title") || "Innovation"}
            </h3>
            <p className="text-muted-foreground">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-semibold mb-2">
              {t("about.coreValues.collaboration.title") || "Collaboration"}
            </h3>
            <p className="text-muted-foreground">
              {t("about.coreValues.collaboration.description") ||
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-semibold mb-2">
              {t("about.coreValues.accessibility.title") || "Accessibility"}
            </h3>
            <p className="text-muted-foreground">
              {t("about.coreValues.accessibility.description") ||
      ...
      <section className="mb-12">
        ...
        <p className="mb-8 text-muted-foreground">
          {t("about.team.description") ||
            "MegaPDF is powered by a small, dedicated team focused on creating the best possible PDF tools for our users."}
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold">
              {t("about.team.member1.name") || "Cakra"}
            </h3>
            <p className="text-primary">
              {t("about.team.member1.role") || "App Development Lead"}
            </p>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold">
              {t("about.team.member2.name") || "Abdi"}
            </h3>
            <p className="text-primary">
              {t("about.team.member2.role") || "Frontend Web Developer"}
            </p>
            <p className="mt-2 text-sm text-muted-foreground">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold">
              {t("about.team.member3.name") || "Anggi"}
            </h3>
            <p className="text-primary">
              {t("about.team.member3.role") || "Marketing Specialist"}
            </p>
            <p className="mt-2 text-sm text-muted-foreground">
      ...
      <section className="text-center">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
          Whether you're a student, professional, or enterprise, MegaPDF is here
          to transform your document management experience.
        </p>
