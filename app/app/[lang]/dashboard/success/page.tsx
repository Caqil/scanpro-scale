// app/[lang]/dashboard/balance/success/page.tsx
"use client";
...
import { CheckCircle2, Home, CreditCard, AlertCircle, Loader2 } from "lucide-react";
...
export default function DepositSuccessPage() {
  ...
  useEffect(() => {
    ...
    const orderId = searchParams.get('PayerID'); // PayPal returns this
  ...
  // Redirect to balance page after 5 seconds on success
  useEffect(() => {
    if (verified) {
        ...
        <CardContent>
          {verifying ? (
            <div className="text-center py-6">
              ...
              <p className="text-sm text-muted-foreground mt-2">Please wait, this won't take long.</p>
            </div>
          ) : verified ? (
            <div className="py-2">
              <div className="bg-green-50 text-green-800 rounded-md p-4 mb-4">
                ...
                <p className="mt-2">
                  ...
                  You will be redirected to your balance page shortly.
                </p>
              </div>
              <p className="text-sm text-muted-foreground">
                Thank you for your deposit. You can now use these funds for operations.
              </p>
            </div>
          ) : (
            <div className="py-2">
              <div className="bg-amber-50 text-amber-800 rounded-md p-4 mb-4">
                ...
                <p className="mt-2">{errorMessage || "We couldn't verify your payment."}</p>
              </div>
              <p className="text-sm text-muted-foreground">
