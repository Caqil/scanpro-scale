...
export default {
    metadata: {
        ...
        description: "Convertissez, éditez, déverrouillez, compressez, fusionnez, divisez et OCR des PDF avec MegaPDF. Outils PDF gratuits et rapides en ligne—aucun téléchargement nécessaire.",
        keywords: "convertisseur PDF, éditeur PDF, OCR en ligne, déverrouiller PDF, compresser PDF, fusionner PDF, diviser PDF, outils PDF gratuits, éditeur PDF en ligne, MegaPDF"
    },
    nav: {
        tools: "Outils",
        company: "Entreprise",
        ...
        appStores: "Obtenir l'application MegaPDF",
    ...
    login: {
        ...
        footer: "© 2025 MegaPDF. Tous droits réservés."
    },
    dashboard: {
    ...
    subscription: {
        ...
        success: {
            ...
            message: "Merci de vous être abonné à MegaPDF ! Vous avez maintenant accès à toutes les fonctionnalités de votre niveau d'abonnement.",
            cta: "Aller au Tableau de bord",
            seo: {
                title: "Abonnement Activé avec Succès - MegaPDF",
                description: "Votre abonnement MegaPDF a été activé. Découvrez toutes les fonctionnalités premium maintenant disponibles pour vous."
            }
        },
        cancel: {
            ...
            seo: {
                title: "Abonnement Annulé - MegaPDF",
    ...
    features: {
        ...
        testimonials: {
            ...
            quote2: "L'intégration de l'API a été fluide. Nous avons intégré MegaPDF dans notre flux de travail et la différence en efficacité est spectaculaire. Leur équipe de support est également de premier ordre.",
            name2: "David Chen",
            title2: "Responsable Technique",
            quote3: "En tant que petite entrepreneuse, les prix abordables et l'ensemble complet d'outils font de MegaPDF une valeur incroyable. J'adore particulièrement l'application mobile qui me permet de gérer des documents en déplacement.",
            name3: "Maria Garcia",
    ...
    about: {
        hero: {
            ...
            description: "MegaPDF est né d'une idée simple : rendre la gestion des documents fluide, efficace et accessible à tous. Nous croyons en la transformation de la manière dont les gens interagissent avec les documents numériques."
        },
        story: {
            title: "Notre histoire",
            paragraph1: "Fondée en 2022, MegaPDF est issue de la frustration liée à l'utilisation d'outils PDF complexes et peu intuitifs. Nos fondateurs, passionnés de technologie et experts en gestion documentaire, ont vu une opportunité de créer une solution à la fois puissante et conviviale.",
        ...
        team: {
            ...
            description: "MegaPDF est alimenté par une petite équipe dédiée concentrée sur la création des meilleurs outils PDF possibles pour nos utilisateurs.",
            member1: {
                name: "Cakra",
    ...
    faq: {
        ...
        general: {
            question1: "Qu'est-ce que MegaPDF ?",
            answer1: "MegaPDF est une plateforme en ligne complète pour la gestion et la conversion de PDF. Nos outils vous aident à convertir, modifier, fusionner, diviser, compresser et sécuriser vos documents PDF via une interface web intuitive ou une API.",
            question2: "Dois-je créer un compte pour utiliser MegaPDF ?",
            ...
            question3: "Mes données sont-elles sécurisées sur MegaPDF ?",
            ...
            question4: "Quels appareils et navigateurs MegaPDF prend-il en charge ?",
            answer4: "MegaPDF fonctionne sur tous les navigateurs modernes, y compris Chrome, Firefox, Safari et Edge. Notre plateforme est entièrement responsive et fonctionne sur les ordinateurs de bureau, les tablettes et les appareils mobiles."
        },
        conversion: {
            question1: "Quels types de fichiers puis-je convertir vers et depuis ?",
            answer1: "MegaPDF permet de convertir des PDF vers de nombreux formats, y compris Word (DOCX), Excel (XLSX), PowerPoint (PPTX), images (JPG, PNG), HTML et texte brut. Vous pouvez également reconvertir ces formats en PDF.",
    ...
    security: {
        ...
        tabContent: {
            ...
            compliance: {
                ...
                approach: {
                    ...
                    description: "MegaPDF est conçu avec la confidentialité et la sécurité dès la conception. Nous examinons et mettons à jour régulièrement nos pratiques pour nous conformer aux réglementations évolutives."
                },
                gdpr: {
        ...
        faq: {
            dataCollection: {
                question: "Quelles données personnelles MegaPDF collecte-t-il ?",
    ...
    developer: {
        ...
        authentication: {
            ...
            apiKeys: {
                title: "Clés API",
                description: "Toutes les requêtes à l'API MegaPDF nécessitent une authentification à l'aide d'une clé API. Votre clé API offre de nombreux privilèges, alors assurez-vous de la garder en sécurité !"
            },
            howTo: {
        ...
        overview: {
            ...
            intro: "L'API MegaPDF vous permet d'intégrer nos capacités de traitement PDF directement dans vos applications. Avec une interface RESTful simple, vous pouvez convertir, compresser, fusionner, diviser et effectuer d'autres opérations sur les PDFs par programmation.",
            features: {
            ...
            startSteps: "Pour commencer avec l'API MegaPDF :",
    ...
    pdfChat: {
        title: "Chat PDF Posez Tout",
        description: "Téléchargez un PDF et posez des questions sur son contenu",
        seo: {
            title: "Chat PDF Posez Tout - Analyse Interactive de Documents PDF",
            description: "Téléchargez un document PDF et posez des questions en langage naturel pour obtenir rapidement des réponses, des résumés et des insights à partir de n'importe quel fichier PDF.",
            keywords: "chat PDF, questions PDF, analyse PDF, IA document, assistant PDF, analyse de documents"
        },
        whatYouCanAsk: {
            title: "Ce Que Vous Pouvez Demander",
            summary: {
                title: "Obtenir des Résumés",
                description: "Demandez des résumés de sections spécifiques ou du document entier."
            },
            find: {
                title: "Trouver des Informations",
                description: "Demandez où apparaissent des informations spécifiques dans le document."
            },
            extract: {
                title: "Extraire des Points Clés",
                description: "Demandez des listes de points clés, dates, noms ou autres informations importantes."
            },
            explain: {
                title: "Obtenir des Explications",
                description: "Demandez des explications sur des concepts complexes mentionnés dans le document."
            }
        },
        faq: {
            title: "Questions Fréquentes",
            q1: {
                question: "Quels types de PDF puis-je utiliser ?",
                answer: "Vous pouvez utiliser n'importe quel fichier PDF contenant du texte. Le système fonctionne mieux avec des PDF numériques, mais peut aussi traiter des documents scannés avec du texte lisible."
            },
            q2: {
                question: "Mes données PDF sont-elles sécurisées ?",
                answer: "Oui, votre PDF est traité de manière sécurisée. Nous ne stockons pas le contenu de vos documents de manière permanente et tout le traitement est effectué dans un environnement sécurisé."
            },
            q3: {
                question: "Y a-t-il des limites de taille ?",
                answer: "Oui, actuellement la taille maximale des fichiers est de 50 Mo. Pour les très gros documents, vous pouvez les diviser en parties plus petites pour un meilleur traitement."
            },
            q4: {
                question: "L'IA comprendra-t-elle les tableaux et graphiques ?",
                answer: "L'IA peut extraire et interpréter le texte des tableaux, mais la compréhension des graphiques ou diagrammes complexes peut être limitée. Elle fonctionne mieux avec du contenu textuel."
            }
        },
        seoContent: {
            title: "Améliorez Votre Analyse de Documents",
            p1: "Notre fonctionnalité \"Posez Tout\" utilise une IA avancée pour vous aider à extraire rapidement des insights de documents PDF. Que vous analysiez des articles de recherche, des contrats juridiques, des manuels techniques ou tout autre document riche en texte, cet outil vous aide à trouver les informations dont vous avez besoin sans passer des heures à lire des pages de contenu.",
            p2: "L'assistant IA peut comprendre le contexte de vos questions et fournir des informations pertinentes à partir du document. Il peut identifier des sections clés, résumer le contenu, expliquer des termes complexes et même trouver des détails spécifiques comme des dates, des montants ou des clauses qui pourraient être enfouis dans le texte.",
            p3: "Cette fonctionnalité est particulièrement utile pour les professionnels qui doivent analyser rapidement des documents, les étudiants qui font des recherches académiques ou toute personne souhaitant gagner du temps en accédant directement aux informations importantes dans ses PDFs.",
            p4: "Essayez-la maintenant en téléchargeant votre PDF et en posant une question !"
        },
        uploading: "Téléchargement du PDF...",
        processing: "Traitement du PDF...",
        thinking: "Réflexion...",
        send: "Envoyer",
        uploadPrompt: "Téléchargez votre document PDF",
        askPrompt: "Posez une question sur le document...",
        newPdf: "Nouveau PDF",
        dropHereDesc: "Déposez votre fichier PDF ici ou cliquez pour parcourir. Je l'analyserai pour que vous puissiez poser des questions sur le contenu.",
        securityNote: "Vos fichiers sont traités de manière sécurisée et ne sont pas stockés de façon permanente.",
        poweredBy: "Propulsé par OpenAI",
        howItWorks: {
            title: "Comment ça Marche",
            step1: {
                title: "Téléchargez votre PDF",
                description: "Glissez-déposez simplement votre fichier PDF dans la zone de téléchargement ou cliquez pour parcourir vos fichiers."
            },
            step2: {
                title: "L'IA traite le contenu",
                description: "Notre IA analyse rapidement l'ensemble du document pour comprendre son contenu et sa structure."
            },
            step3: {
    ...
    removePdf: {
        title: "Supprimer des pages d'un PDF",
        description: "Supprimez facilement les pages indésirables de vos documents PDF avec un aperçu visuel et un contrôle précis.",
        uploadTitle: "Télécharger un PDF pour supprimer des pages",
        uploadDesc: "Sélectionnez un fichier PDF pour supprimer des pages spécifiques tout en préservant la qualité des pages restantes.",
        selectPages: "Sélectionner les pages à supprimer",
        selectPagesDesc: "Cliquez sur les miniatures des pages pour les prévisualiser ou cochez la case pour les marquer pour suppression",
        pagesSelected: "pages sélectionnées",
        pagesRemaining: "pages resteront",
        selectMax: "Sélectionner Max",
        clearSelection: "Effacer la sélection",
        saveDocument: "Enregistrer le document",
        preview: "Aperçu du résultat",
        previewDesc: "Pages qui resteront dans votre document : {remaining}",
        processing: "Suppression des pages",
        page: "Page",
        pagePreview: "Aperçu de la page -",
      ...
      terms: {
        ...
        meta: {
          title: "Conditions de Service | MegaPDF - Outils PDF",
          description: "Conditions de Service pour les outils PDF de MegaPDF. Lisez nos termes et conditions pour l'utilisation de nos services."
        },
        lastUpdated: "Dernière mise à jour : 18 mars 2025",
        welcome: "Bienvenue chez MegaPDF. Veuillez lire attentivement ces Conditions de Service avant d'utiliser notre site web, nos applications mobiles et nos services (collectivement, les Services).",
        sections: {
          acceptance: {
            title: "1. Acceptation des Conditions",
            content: "En accédant à nos Services ou en les utilisant, vous acceptez d'être lié par ces Conditions. Si vous n'acceptez pas ces Conditions, veuillez ne pas utiliser nos Services."
          },
          services: {
            title: "2. Description des Services",
            description: "MegaPDF fournit des outils pour la conversion, la manipulation et l'optimisation de documents PDF, y compris, mais sans s'y limiter :",
            features: {
              feature1: "Conversion de PDFs en divers formats (DOCX, XLSX, JPG, etc.)",
              feature2: "Conversion de documents au format PDF",
              feature3: "Compression de fichiers PDF",
              feature4: "Fusion de plusieurs fichiers PDF",
              feature5: "Division de fichiers PDF en documents séparés",
              feature6: "Rotation des pages PDF",
              feature7: "Ajout de filigranes aux fichiers PDF",
              feature8: "Autres fonctions de traitement PDF"
            }
          },
          account: {
            title: "3. Inscription au Compte",
            registration: "3.1. Certaines fonctionnalités de nos Services peuvent nécessiter la création d'un compte. Lors de l'inscription, vous acceptez de fournir des informations précises, actuelles et complètes.",
            responsibility: "3.2. Vous êtes responsable de maintenir la confidentialité de vos identifiants de compte et de toutes les activités qui se déroulent sous votre compte.",
            security: "3.3. Vous acceptez de nous informer immédiatement de toute utilisation non autorisée de votre compte ou de toute autre violation de la sécurité."
          },
          obligations: {
            title: "4. Obligations de l'Utilisateur",
            lawfulUse: {
              title: "4.1. Utilisation Légale.",
              description: "Vous acceptez d'utiliser nos Services uniquement à des fins légales et conformément à ces Conditions. Vous acceptez de ne pas utiliser nos Services :",
              restrictions: {
                restriction1: "D'une manière qui viole toute loi ou réglementation fédérale, étatique, locale ou internationale applicable",
                restriction2: "Pour transmettre tout matériel contenant des virus, des chevaux de Troie, des vers, des malwares ou tout autre code nuisible",
                restriction3: "Pour enfreindre ou violer nos droits de propriété intellectuelle ou les droits de propriété intellectuelle d'autrui"
              }
            },
            content: {
              title: "4.2. Propriété et Responsabilité du Contenu.",
              description: "Vous conservez tous les droits de propriété sur les fichiers que vous téléchargez sur nos Services. Vous êtes seul responsable du contenu de vos fichiers et de la légalité de leur téléchargement, traitement et téléchargement."
            },
            sensitiveInfo: {
              title: "4.3. Aucune Information Sensible.",
              description: "Vous acceptez de ne pas télécharger de fichiers contenant des informations personnelles sensibles telles que des numéros de sécurité sociale, des informations de comptes financiers, des informations de santé ou toute autre information soumise à une protection réglementaire spécifique."
            }
          },
          privacy: {
            title: "5. Confidentialité",
            description: {
              before: "Votre vie privée est importante pour nous. Notre ",
              link: "Politique de Confidentialité",
              after: ", qui est incorporée à ces Conditions par référence, explique comment nous collectons, utilisons et divulguons des informations vous concernant."
            }
          },
          intellectual: {
            ...
            ownership: {
              ...
              description: "Les Services, y compris tout le contenu, les fonctionnalités et les caractéristiques, nous appartiennent, à nos concédants de licence ou à d'autres fournisseurs et sont protégés par les lois sur le droit d'auteur, les marques déposées et autres lois de propriété intellectuelle."
            },
            license: {
              title: "6.2. Licence Limitée d'Utilisation.",
              description: "Nous vous accordons une licence limitée, non exclusive, non transférable et révocable pour utiliser nos Services à des fins personnelles ou professionnelles internes."
            }
          },
          disclaimers: {
            title: "7. Clauses de Non-Responsabilité et Limites de Responsabilité",
            asis: {
              title: "7.1. Service Fourni Tel Quel.",
              description: "Les Services sont fournis TELS QUELS et SELON DISPONIBILITÉ, sans garanties d'aucune sorte, expresses ou implicites, y compris, mais sans s'y limiter, les garanties implicites de qualité marchande, d'adéquation à un usage particulier ou de non-contrefaçon."
            },
            liability: {
              title: "7.2. Limitation de Responsabilité.",
              description: "Dans toute la mesure permise par la loi applicable, en aucun cas nous, nos affiliés, prestataires de services, employés, agents, dirigeants ou directeurs ne serons responsables des dommages de quelque nature que ce soit, sous quelque théorie juridique que ce soit, découlant de ou en relation avec votre utilisation ou votre incapacité à utiliser les Services, y compris tout dommage direct, indirect, spécial, accessoire, consécutif ou punitif."
            }
          },
          termination: {
            title: "8. Durée et Résiliation",
            duration: "8.1. Ces Conditions resteront en plein effet tant que vous utiliserez les Services.",
            rights: "8.2. Nous pouvons résilier ou suspendre votre accès à tout ou partie des Services, avec ou sans préavis, pour tout comportement que nous, à notre seule discrétion, considérons comme une violation de ces Conditions ou nuisible à d'autres utilisateurs des Services, à nous ou à des tiers, ou pour toute autre raison.",
            effect: "8.3. En cas de résiliation, votre droit d'utiliser les Services cessera immédiatement."
          },
          changes: {
            title: "9. Modifications des Conditions",
            description: "Nous nous réservons le droit de modifier ces Conditions à tout moment. Nous vous informerons de tout changement important en publiant les nouvelles Conditions sur les Services et en mettant à jour la date de dernière mise à jour. Votre utilisation continue des Services après ces changements constitue votre acceptation des nouvelles Conditions."
          },
          contact: {
            ...
            address: {
              label: "Adresse :",
              value: "Indonésie, Bangka Belitung"
            }
          }
        },
        agreement: "En utilisant MegaPDF, vous reconnaissez avoir lu, compris et accepté d'être lié par ces Conditions de Service.",
        viewPrivacyPolicy: "Voir la Politique de Confidentialité"
      },
      privacy: {
        title: "Politique de confidentialité",
        meta: {
          title: "Politique de confidentialité | MegaPDF - Outils PDF",
          description: "Politique de confidentialité pour les outils PDF MegaPDF. Découvrez comment nous traitons vos données et protégeons votre vie privée."
        },
        lastUpdated: "Dernière mise à jour : 18 mars 2025",
        introduction: "Cette politique de confidentialité décrit comment MegaPDF collecte, utilise et divulgue des informations lorsque vous utilisez notre site web, nos applications mobiles et nos services (collectivement, les Services).",
        sections: {
          informationWeCollect: {
            title: "1. Informations que nous collectons",
            description: "Nous collectons plusieurs types d'informations auprès des utilisateurs de nos Services et à leur sujet :"
          },
          informationYouProvide: {
            title: "1.1. Informations que vous nous fournissez",
            account: {
              label: "Informations de compte :",
              description: "Lorsque vous créez un compte, nous collectons votre nom, votre adresse e-mail et votre mot de passe."
            },
            payment: {
              label: "Informations de paiement :",
              description: "Si vous achetez des services premium, nous collectons des informations de paiement, qui peuvent inclure les détails de votre carte de crédit, votre adresse de facturation et d'autres informations financières. Le traitement des paiements est géré par nos processeurs de paiement tiers, et nous ne stockons pas les informations complètes de carte de crédit sur nos serveurs."
            },
            files: {
              label: "Fichiers et contenu :",
              description: "Nous collectons les fichiers que vous téléchargez sur nos Services pour traitement (comme les PDF et autres documents)."
            },
            communications: {
              label: "Communications :",
              description: "Si vous nous contactez directement, nous pouvons collecter des informations sur votre communication et toute information supplémentaire que vous fournissez."
            }
          },
          automaticInformation: {
            title: "1.2. Informations que nous collectons automatiquement",
            usage: {
              label: "Données d'utilisation :",
              description: "Nous collectons des informations sur la manière dont vous interagissez avec nos Services, y compris les fonctionnalités que vous utilisez, le temps passé sur les Services et les pages que vous visitez."
            },
            device: {
              label: "Informations sur l'appareil et la connexion :",
              description: "Nous collectons des informations sur votre appareil et votre connexion Internet, y compris votre adresse IP, le type de navigateur, le système d'exploitation et les identifiants de l'appareil."
            },
            cookies: {
              label: "Cookies et technologies similaires :",
              description: "Nous utilisons des cookies et des technologies de suivi similaires pour suivre l'activité sur nos Services et conserver certaines informations. Pour plus d'informations sur notre utilisation des cookies, veuillez consulter la section 5 ci-dessous."
            }
          },
          howWeUse: {
            title: "2. Comment nous utilisons vos informations",
            description: "Nous utilisons les informations que nous collectons à diverses fins, notamment pour :",
            purposes: {
              purpose1: "Fournir, maintenir et améliorer nos Services",
              purpose2: "Traiter et finaliser les transactions, et envoyer des informations connexes, y compris des confirmations",
              purpose3: "Envoyer des informations administratives, telles que des mises à jour, des alertes de sécurité et des messages de support",
              purpose4: "Répondre à vos commentaires, questions et demandes, et fournir un service client",
              purpose5: "Communiquer avec vous au sujet des produits, services, offres, promotions et événements",
              purpose6: "Surveiller et analyser les tendances, l'utilisation et les activités en lien avec nos Services",
              purpose7: "Détecter, enquêter et prévenir les transactions frauduleuses et autres activités illégales",
              purpose8: "Personnaliser et améliorer votre expérience avec nos Services"
            }
          },
          fileHandling: {
            title: "3. Comment nous traitons vos fichiers",
            processing: {
              title: "3.1. Traitement des fichiers",
              description: "Les fichiers que vous téléchargez sur nos Services sont traités sur nos serveurs pour fournir la fonctionnalité de conversion ou de manipulation demandée. Ce traitement est généralement automatisé et n'implique pas d'examen humain de votre contenu."
            },
            storage: {
              title: "3.2. Stockage et conservation des fichiers",
              temporary: {
                label: "Stockage temporaire :",
                description: "Les fichiers téléchargés sont stockés temporairement sur nos serveurs pour fournir nos Services. Les fichiers sont automatiquement supprimés après 24 heures, sauf si vous êtes un utilisateur premium avec des options de stockage prolongé."
              },
              converted: {
                label: "Fichiers convertis :",
                description: "Les fichiers convertis ou traités résultants sont également stockés temporairement et sont disponibles au téléchargement pendant 24 heures, après quoi ils sont automatiquement supprimés."
              }
            },
            security: {
              title: "3.3. Sécurité des fichiers",
              description: "Nous mettons en œuvre des mesures de sécurité raisonnables conçues pour protéger vos fichiers contre tout accès, divulgation, altération ou destruction non autorisés. Cependant, veuillez noter qu'aucune méthode de transmission sur Internet ou de stockage électronique n'est sécurisée à 100 %."
            }
          },
          sharing: {
            title: "4. Partage des informations",
            description: "Nous pouvons partager des informations comme suit :",
            serviceProviders: {
              title: "4.1. Prestataires de services",
              description: "Nous pouvons partager vos informations avec des fournisseurs tiers, des prestataires de services, des entrepreneurs ou des agents qui effectuent des services en notre nom, tels que le traitement des paiements, l'analyse de données, la livraison d'e-mails, les services d'hébergement et le service client."
            },
            businessTransfers: {
              title: "4.2. Transferts d'entreprise",
              description: "Si nous sommes impliqués dans une fusion, une acquisition, un financement, une réorganisation, une faillite ou une vente d'actifs de l'entreprise, vos informations peuvent être transférées dans le cadre de cette transaction."
            },
            legal: {
              title: "4.3. Exigences légales",
              description: "Nous pouvons divulguer vos informations si la loi l'exige ou en réponse à des demandes valides des autorités publiques (par exemple, un tribunal ou une agence gouvernementale)."
            }
          },
          cookies: {
            title: "5. Cookies et technologies de suivi",
            types: {
              title: "5.1. Types de cookies que nous utilisons",
              essential: {
                label: "Cookies essentiels :",
                description: "Ces cookies sont nécessaires pour que les Services fonctionnent correctement."
              },
              analytics: {
                label: "Cookies analytiques :",
                description: "Nous utilisons ces cookies pour analyser comment les utilisateurs interagissent avec nos Services, ce qui nous aide à améliorer la fonctionnalité et l'expérience utilisateur."
              },
              preference: {
                label: "Cookies de préférence :",
                description: "Ces cookies nous permettent de mémoriser des informations qui modifient le comportement ou l'apparence des Services, comme votre langue ou région préférée."
              }
            }
          },
          rights: {
            title: "6. Vos droits et choix",
            description: "Selon votre emplacement, vous pouvez avoir certains droits concernant vos informations personnelles :",
            options: {
              option1: "Demander l'accès à vos informations personnelles",
              option2: "Demander la correction d'informations inexactes",
              option3: "Demander la suppression de vos informations",
              option4: "S'opposer à notre traitement de vos informations",
              option5: "Demander la restriction du traitement",
              option6: "Demander la portabilité des données",
              option7: "Retirer votre consentement à tout moment, lorsque le traitement est basé sur le consentement"
            }
          },
          contact: {
            title: "7. Informations de contact",
            description: "Si vous avez des questions ou des préoccupations concernant cette politique de confidentialité ou nos pratiques en matière de données, veuillez nous contacter à :",
            email: {
              label: "E-mail :",
        ...
        acknowledgment: "En utilisant MegaPDF, vous reconnaissez avoir lu et compris cette politique de confidentialité.",
        viewTerms: "Voir les conditions de service"
    },
    cookies: {
        title: "Politique de Cookies",
        lastUpdated: "Dernière mise à jour : {date}",
        overview: "Aperçu",
        intro: "Cette Politique de Cookies explique ce que sont les cookies et comment nous les utilisons sur notre site web. Nous vous recommandons de lire cette politique pour comprendre ce que sont les cookies, comment nous les utilisons, les types de cookies que nous utilisons, et comment vous pouvez gérer vos préférences en matière de cookies.",
        
        tabs: {
          what: "Que sont les Cookies",
          types: "Types de Cookies",
          how: "Comment Nous Utilisons les Cookies",
        ...
        whatAre: {
          ...
          description: "Les cookies sont de petits fichiers texte qui sont stockés sur votre ordinateur ou appareil mobile lorsque vous visitez un site web. Ils sont largement utilisés pour rendre les sites web plus efficaces et fournir des informations aux propriétaires des sites.",
          purpose: "Les cookies nous permettent de reconnaître votre appareil et de vous offrir une expérience personnalisée. Ils sont également utilisés pour garantir la sécurité de votre compte, analyser l'utilisation de notre service, et aider dans nos efforts de marketing."
        },
        ...
        types: {
          ...
          essential: {
            ...
            description: "Ces cookies sont nécessaires pour que le site web fonctionne correctement. Ils permettent des fonctions de base comme la navigation sur les pages et l'accès aux zones sécurisées du site. Le site web ne peut pas fonctionner correctement sans ces cookies.",
            examples: {
              session: "Cookies de session pour l'authentification",
              csrf: "Jetons CSRF pour la sécurité",
              load: "Cookies d'équilibrage de charge"
            }
          },
          functional: {
            title: "Cookies Fonctionnels",
            description: "Ces cookies permettent au site web de fournir des fonctionnalités améliorées et une personnalisation. Ils peuvent être définis par nous ou par des fournisseurs tiers dont nous avons ajouté les services à nos pages.",
            examples: {
              language: "Cookies de préférence linguistique",
              theme: "Cookies de personnalisation de l'interface utilisateur"
            }
          },
          analytics: {
            title: "Cookies Analytiques",
            description: "Ces cookies nous aident à comprendre comment les visiteurs interagissent avec notre site web. Ils fournissent des informations sur des métriques telles que le nombre de visiteurs, le taux de rebond, la source de trafic, etc.",
            examples: {
              ga: "Cookies Google Analytics",
              heatmap: "Cookies de suivi du comportement des utilisateurs"
            }
          },
          advertising: {
            title: "Cookies Publicitaires",
            description: "Ces cookies sont utilisés pour suivre les visiteurs à travers les sites web. L'objectif est d'afficher des publicités pertinentes et attrayantes pour l'utilisateur individuel, et donc plus précieuses pour les éditeurs et les annonceurs tiers."
          }
        },
        
        howWeUse: {
          title: "Comment Nous Utilisons les Cookies",
          description: "Nous utilisons des cookies pour diverses raisons, notamment :",
          purposes: {
            authentication: "Pour authentifier les utilisateurs et empêcher l'utilisation frauduleuse des comptes utilisateurs",
            security: "Pour améliorer la sécurité de notre service",
            preferences: "Pour mémoriser des informations sur vos préférences et paramètres",
            analytics: "Pour nous aider à comprendre comment vous utilisez notre site web, ce qui nous permet d'améliorer les fonctionnalités et l'expérience utilisateur",
            features: "Pour activer certaines fonctionnalités et fonctions de notre service"
          }
        },
        
        thirdParty: {
          title: "Cookies Tiers",
          description: "En plus de nos propres cookies, nous pouvons également utiliser divers cookies tiers pour rapporter des statistiques d'utilisation, diffuser des publicités, et ainsi de suite.",
          providers: {
            analytics: "Utilisés pour collecter des informations sur la manière dont vous utilisez notre site web, y compris les pages que vous visitez le plus souvent. Nous utilisons ces informations pour améliorer notre site web et nos services.",
            payment: "Utilisés pour traiter les paiements et prévenir la fraude pour les abonnements et les achats sur notre plateforme.",
            heatmap: "Utilisés pour comprendre comment les utilisateurs interagissent avec différents éléments de nos pages à travers des cartes thermiques et des enregistrements de sessions."
          }
        },
        
        manage: {
          title: "Gérer Vos Préférences de Cookies",
          description: "La plupart des navigateurs web vous permettent de contrôler les cookies via leurs préférences de configuration. Cependant, si vous limitez la capacité des sites web à définir des cookies, cela peut affecter votre expérience utilisateur globale, et certaines fonctionnalités de notre site web peuvent ne pas fonctionner comme prévu.",
          browser: {
            title: "Contrôles du Navigateur",
            description: "Vous pouvez gérer les cookies via les paramètres de votre navigateur. Voici comment le faire dans les navigateurs populaires :",
            ...
            edge: "Paramètres > Cookies et autorisations de sites > Cookies et données de sites"
          },
          warning: "Veuillez noter que la désactivation des cookies essentiels affectera la fonctionnalité de notre site web, et certaines fonctionnalités pourraient ne pas fonctionner correctement."
        },
