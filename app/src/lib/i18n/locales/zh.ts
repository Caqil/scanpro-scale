...
export default {
    ...
    removePdf: {
        title: "从PDF删除页面",
        description: "通过可视化预览和精确控制，轻松删除PDF文档中不需要的页面。",
        uploadTitle: "上传PDF以删除页面",
        uploadDesc: "选择PDF文件以删除特定页面，同时保留剩余页面的质量。",
        selectPages: "选择要删除的页面",
        selectPagesDesc: "点击页面缩略图预览或勾选复选框标记删除。",
        pagesSelected: "页已选择",
        pagesRemaining: "页将保留",
        selectMax: "全选",
        clearSelection: "清除选择",
        saveDocument: "保存文档",
        preview: "预览结果",
        previewDesc: "文档中将保留的页面: {remaining}",
        processing: "正在删除页面",
        page: "页",
        pagePreview: "页面预览 -",
