...
export default {
    ...
    removePdf: {
        ...
        description: "Görsel önizleme ve hassas kontrol ile PDF belgelerinizden istenmeyen sayfaları kolayca kaldırın.",
        uploadTitle: "Sayfa Silmek için PDF Yükle",
        uploadDesc: "Belirli sayfaları silerken kalan sayfaların kalitesini koruyarak PDF dosyası seçin.",
        selectPages: "Silinecek Sayfaları Seç",
        selectPagesDesc: "Sayfa küçük resimlerini önizlemek için tıklayın veya silmek için kutuyu işaretleyin.",
        pagesSelected: "sayfa seçildi",
        pagesRemaining: "sayfa kalacak",
        selectMax: "Tümünü Seç",
        clearSelection: "Seçimi Temizle",
        saveDocument: "Belgeyi Kaydet",
        preview: "Sonucu Önizle",
        previewDesc: "Belgenizde kalacak sayfalar: {remaining}",
        processing: "Sayfalar Siliniyor",
        page: "Sayfa",
        pagePreview: "Sayfa Önizleme -",
