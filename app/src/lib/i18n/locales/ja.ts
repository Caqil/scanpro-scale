...
export default {
  ...
  splitPdf: {
    ...
    faq: {
      ...
      q1: {
        ...
        answer: "プライバシーとセキュリティのために、アップロードおよび生成されたすべてのファイルは1時間後にサーバーから自動的に削除されます。"
      },
      q2: {
  ...
  compressPdf: {
    ...
    faq: {
      ...
      secure: {
        ...
        answer: "はい、データは安全です。すべてのPDFファイルは安全にオンライン処理され、1時間後に自動的に削除されます。WindowsでもLinuxでも、ファイルは暗号化され、共有されることはありません。"
      },
      fileLimits: {
  ...
  fileUploader: {
    ...
    filesSecurity: "プライバシーとセキュリティのためにファイルは1時間後に自動的に削除されます。"
  },
  ...
  contact: {
    ...
    faq: {
      ...
      responseTime: {
        ...
        answer: "すべての問い合わせに1〜48営業時間以内に返信することを目指しています。ピーク時には最大72時間かかる場合があります。"
      },
      technicalSupport: {
  ...
  legal: {
    ...
    dataUse: {
      title: "データの使用方法",
      description: "ご依頼いただいたサービスを提供するためにのみファイルを処理します。すべてのファイルは1時間後に自動的に削除されます。"
    },
    cookies: {
      title: "クッキーとトラッキング",
  ...
  security: {
    ...
    sections: {
      ...
      temporaryStorage: {
        title: "一時保存",
        description: "ファイルは処理後1時間以内に自動的に削除されます。必要な期間以上にドキュメントを保持することはありません。"
      },
      access: {
        title: "アクセス制御",
    ...
    retention: {
      ...
      documents: {
        ...
        description: "ファイルは処理後1時間以内に当社サーバーから自動的に削除されます。有料プラン向けのストレージ機能を明示的に選択しない限り、ドキュメントのコピーは保持しません。"
      },
      account: {
        title: "アカウント情報",
    ...
    faq: {
      ...
      documentStorage: {
        ...
        answer: "ドキュメントは通常、処理後1時間以内に当社サーバーから自動削除されます。有料サブスクリプションではドキュメント保存オプションを利用できますが、これは明示的な選択が必要な機能です。"
      },
      thirdParty: {
  ...
  ocrPdf: {
    ...
    faq1Answer: 'はい、データのセキュリティを非常に重要視しています。すべてのファイルのアップロードと処理は、セキュアなサーバーで行われます。ファイルは1時間後に自動的に削除され、OCRサービスを提供する以外の目的では使用しません。',
  ...
  pdfChat: {
    title: "PDFについて何でも質問",
    description: "PDFをアップロードして内容について質問する",
    seo: {
      title: "PDFについて何でも質問 - インタラクティブなPDFドキュメント分析",
      description: "PDFドキュメントをアップロードして自然言語で質問し、素早く回答、要約、洞察を得ることができます。",
      keywords: "PDFチャット, PDF質問, PDF分析, ドキュメントAI, PDFアシスタント, ドキュメント分析"
    },
    whatYouCanAsk: {
      title: "質問できる内容",
      summary: {
        title: "要約を取得",
        description: "特定のセクションまたはドキュメント全体の要約をリクエストできます。"
      },
      find: {
        title: "情報を検索",
        description: "ドキュメント内の特定の情報がどこにあるか質問できます。"
      },
      extract: {
        title: "キーポイントを抽出",
        description: "キーポイント、日付、名前などの重要な情報のリストをリクエストできます。"
      },
      explain: {
        title: "説明を取得",
        description: "ドキュメント内の複雑な概念についての説明をリクエストできます。"
      }
    },
    faq: {
      title: "よくある質問",
      q1: {
        question: "どのようなPDFが使用できますか？",
        answer: "テキストを含むPDFファイルであれば使用可能です。デジタルPDFで最も効果的ですが、スキャンされた文書でも読み取り可能なテキストがあれば処理できます。"
      },
      q2: {
        question: "PDFデータは安全ですか？",
        answer: "はい、PDFは安全に処理されます。ドキュメント内容を永続的に保存せず、すべての処理は安全な環境で行われます。"
      },
      q3: {
        question: "サイズ制限はありますか？",
        answer: "はい、現在の最大ファイルサイズは50MBです。非常に大きなドキュメントの場合は、より良い処理のために小さな部分に分割することをお勧めします。"
      },
      q4: {
        question: "AIは表やグラフを理解しますか？",
        answer: "AIは表からテキストを抽出・解釈できますが、複雑なグラフや図の理解には限界があります。テキストコンテンツで最も効果的です。"
      }
    },
    seoContent: {
      title: "ドキュメント分析を強化",
      p1: "「何でも質問」機能は高度なAIを活用し、PDFドキュメントから迅速に洞察を抽出します。研究論文、法律契約、技術マニュアル、テキストの多いドキュメントを分析する際に、何時間も内容を読むことなく必要な情報を見つけるのに役立ちます。",
      p2: "AIアシスタントは質問の文脈を理解し、ドキュメントから関連情報を提供できます。重要なセクションを特定し、内容を要約し、複雑な用語を説明し、テキスト内に埋もれた日付、金額、条項などの詳細を見つけることも可能です。",
      p3: "この機能は、ドキュメントを迅速に分析する必要がある専門家、学術論文を研究する学生、PDF内の重要な情報に直接アクセスして時間を節約したい方に特に有用です。",
      p4: "今すぐPDFをアップロードして質問してみてください！"
    },
    uploading: "PDFをアップロード中...",
    processing: "PDFを処理中...",
    thinking: "処理中...",
    send: "送信",
    uploadPrompt: "PDFドキュメントをアップロード",
    askPrompt: "ドキュメントについて質問...",
    newPdf: "新しいPDF",
    dropHereDesc: "PDFファイルをここにドロップするか、クリックして参照してください。内容について質問できるように分析します。",
    securityNote: "ファイルは安全に処理され、永続的に保存されません。",
    poweredBy: "OpenAI提供",
    howItWorks: {
      title: "使い方",
      step1: {
        title: "PDFをアップロード",
        description: "PDFファイルをアップロードエリアにドラッグ＆ドロップするか、クリックしてファイルを参照します。"
      },
      step2: {
        title: "AIが内容を処理",
        description: "AIがドキュメント全体を迅速に分析し、内容と構造を理解します。"
      },
      step3: {
        title: "質問する",
        description: "ドキュメントについて何でも質問し、PDFの内容から正確な回答を得ます。"
      }
    },
  },
  removePdf: {
  ...
  terms: {
    title: "サービス利用規約",
    meta: {
      title: "サービス利用規約 | MegaPDF - PDFツール",
      description: "MegaPDF PDFツールのサービス利用規約。当社のサービスの利用に関する規約と条件をご覧ください。"
    },
    lastUpdated: "最終更新日: 2025年3月18日",
    welcome: "MegaPDFへようこそ。当社のウェブサイト、モバイルアプリケーション、およびサービス（総称して「サービス」）をご利用になる前に、このサービス利用規約をよくお読みください。",
    sections: {
      acceptance: {
        title: "1. 規約の承諾",
        content: "当社のサービスにアクセスまたは利用することで、貴方は本規約に拘束されることに同意します。本規約に同意しない場合、当社のサービスを利用しないでください。"
      },
      services: {
        title: "2. サービスの説明",
        description: "MegaPDFは、PDFドキュメントの変換、操作、最適化のためのツールを提供します。以下を含むがこれに限定されません：",
        features: {
          feature1: "PDFをさまざまな形式（DOCX、XLSX、JPGなど）に変換",
          feature2: "ドキュメントをPDF形式に変換",
          feature3: "PDFファイルの圧縮",
          feature4: "複数のPDFファイルの結合",
          feature5: "PDFファイルを個別のドキュメントに分割",
          feature6: "PDFページの回転",
          feature7: "PDFファイルへの透かし追加",
          feature8: "その他のPDF処理機能"
        }
      },
      account: {
        title: "3. アカウント登録",
        registration: "3.1. 当社のサービスの一部の機能を利用するには、アカウント登録が必要です。登録する際、正確で最新かつ完全な情報を提供することに同意します。",
        responsibility: "3.2. 貴方はアカウントの認証情報の機密性を維持し、貴方のアカウント下で発生するすべての活動について責任を負います。",
        security: "3.3. 貴方のアカウントの不正使用またはその他のセキュリティ違反があった場合、直ちに当社に通知することに同意します。"
      },
      obligations: {
        title: "4. 利用者の義務",
        lawfulUse: {
          title: "4.1. 合法的な使用。",
          description: "貴方は当社のサービスを合法的な目的でのみ、かつ本規約に従って使用することに同意します。貴方は当社のサービスを以下のように使用しないことに同意します：",
          restrictions: {
            restriction1: "適用される連邦、州、地方、または国際的な法律または規制に違反する方法",
            restriction2: "ウイルス、トロイの木馬、ワーム、マルウェア、またはその他の有害なコードを含む素材を送信する目的",
            restriction3: "当社または他者の知的財産権を侵害または違反する目的"
          }
        },
        content: {
          title: "4.2. コンテンツの所有権と責任。",
          description: "貴方は当社のサービスにアップロードしたファイルのすべての所有権を保持します。貴方のファイルのコンテンツおよびそのアップロード、処理、ダウンロードの合法性については、貴方が全責任を負います。"
        },
        sensitiveInfo: {
          title: "4.3. 機密情報の禁止。",
          description: "貴方は、社会保障番号、財務口座情報、健康情報、または特定の規制保護の対象となるその他の情報など、機密性の高い個人情報を含むファイルをアップロードしないことに同意します。"
        }
      },
      privacy: {
        title: "5. プライバシー",
        description: {
          before: "貴方のプライバシーは当社にとって重要です。当社の",
          link: "プライバシーポリシー",
          after: "は、本規約に参照として組み込まれており、貴方に関する情報の収集、使用、開示方法を説明しています。"
        }
      },
      intellectual: {
        title: "6. 知的財産権",
        ownership: {
          title: "6.1. 当社の知的財産。",
          description: "サービス（すべてのコンテンツ、機能、機能性を含む）は、当社、ライセンサー、または他のプロバイダーが所有し、著作権、商標、その他の知的財産法によって保護されています。"
        },
        license: {
          title: "6.2. 使用のための限定ライセンス。",
          description: "当社は、貴方の個人的または内部的なビジネス目的のために当社のサービスを使用するための、限定された非独占的、非譲渡可能、かつ取り消し可能なライセンスを貴方に付与します。"
        }
      },
      disclaimers: {
        title: "7. 免責事項および責任の制限",
        asis: {
          title: "7.1. サービスは現状のまま提供。",
          description: "サービスは現状のままおよび利用可能な状態で提供され、明示または黙示を問わず、いかなる保証もありません。これには、商品性、特定目的への適合性、または非侵害の黙示保証が含まれますが、これに限定されません。"
        },
        liability: {
          title: "7.2. 責任の制限。",
          description: "適用法で認められる最大限の範囲で、当社または当社の関連会社、サービスプロバイダー、従業員、代理人、役員、または取締役は、貴方のサービス利用または利用不能に起因する、または関連するいかなる種類の損害（直接的、間接的、特別、偶発的、結果的、または懲罰的損害を含む）について、法的理論を問わず、責任を負いません。"
        }
      },
      termination: {
        title: "8. 期間および終了",
        duration: "8.1. 本規約は、貴方がサービスを利用する間、完全に効力を有します。",
        rights: "8.2. 当社は、独自の裁量により、本規約に違反する、または他のサービス利用者、当社、または第三者に有害であると当社が判断する行為、またはその他の理由により、通知の有無にかかわらず、貴方のすべてのサービスまたはその一部へのアクセスを終了または一時停止することができます。",
        effect: "8.3. 終了後、貴方のサービス利用権は直ちに終了します。"
      },
      changes: {
        title: "9. 規約の変更",
        description: "当社は、いつでも本規約を変更する権利を留保します。重大な変更については、サービスに新しい規約を掲載し、最終更新日を更新することで通知します。変更後のサービスの継続的な利用は、貴方が新しい規約を受け入れたことを意味します。"
      },
      contact: {
        title: "10. 連絡先情報",
        description: "本規約に関するご質問がある場合、以下までご連絡ください：",
        email: {
          label: "メール：",
        ...
        address: {
          label: "住所：",
          value: "インドネシア、バンカ・ベルトゥン"
        }
      }
    },
    agreement: "MegaPDFを利用することで、貴方は本サービス利用規約を読み、理解し、これに拘束されることに同意したことを認めます。",
    viewPrivacyPolicy: "プライバシーポリシーを表示"
  },
  privacy: {
    title: "プライバシーポリシー",
    meta: {
      title: "プライバシーポリシー | MegaPDF - PDFツール",
      description: "MegaPDF PDFツールのプライバシーポリシー。あなたのデータの取り扱い方法とプライバシー保護についてご覧ください。"
    },
    lastUpdated: "最終更新日：2025年3月18日",
    introduction: "このプライバシーポリシーは、MegaPDFが当社のウェブサイト、モバイルアプリケーション、およびサービス（総称して「サービス」）を利用する際に、情報を収集、使用、開示する方法を説明します。",
    sections: {
      informationWeCollect: {
        title: "1. 収集する情報",
        description: "当社のサービスのユーザーから、またはユーザーに関するいくつかの種類の情報を収集します："
      },
      informationYouProvide: {
        title: "1.1. あなたが提供する情報",
        account: {
          label: "アカウント情報：",
          description: "アカウントに登録する際、あなたの名前、メールアドレス、パスワードを収集します。"
        },
        payment: {
          label: "支払い情報：",
          description: "プレミアムサービスを購入する場合、クレジットカードの詳細、請求先住所、その他の財務情報を含む支払い情報を収集します。支払い処理は第三者の決済処理業者によって行われ、当社のサーバーには完全なクレジットカード情報は保存されません。"
        },
        files: {
          label: "ファイルとコンテンツ：",
          description: "当社のサービスに処理のためにアップロードするファイル（PDFやその他のドキュメントなど）を収集します。"
        },
        communications: {
          label: "コミュニケーション：",
          description: "直接ご連絡いただいた場合、コミュニケーションに関する情報およびあなたが提供する追加情報を収集することがあります。"
        }
      },
      automaticInformation: {
        title: "1.2. 自動的に収集する情報",
        usage: {
          label: "使用データ：",
          description: "当社のサービスとの対話方法に関する情報を収集します。これには、使用する機能、サービスでの滞在時間、訪問するページが含まれます。"
        },
        device: {
          label: "デバイスおよび接続情報：",
          description: "あなたのデバイスおよびインターネット接続に関する情報を収集します。これには、IPアドレス、ブラウザの種類、オペレーティングシステム、デバイス識別子が含まれます。"
        },
        cookies: {
          label: "クッキーおよび類似技術：",
          description: "当社のサービスでの活動を追跡し、特定の情報を保持するために、クッキーおよび類似の追跡技術を使用します。クッキーの使用に関する詳細は、以下のセクション5をご覧ください。"
        }
      },
      howWeUse: {
        title: "2. 情報の使用方法",
        description: "収集した情報は、以下を含むさまざまな目的で使用します：",
        purposes: {
          purpose1: "当社のサービスを提供、維持、改善する",
          purpose2: "取引を処理および完了し、確認書を含む関連情報を送信する",
          purpose3: "更新、セキュリティアラート、サポートメッセージなどの管理情報を送信する",
          purpose4: "あなたのコメント、質問、要望に対応し、カスタマーサービスを提供する",
          purpose5: "製品、サービス、オファー、プロモーション、イベントについてあなたとコミュニケーションする",
          purpose6: "当社のサービスに関連する傾向、使用状況、活動を監視および分析する",
          purpose7: "詐欺的な取引やその他の違法な活動を検出、調査、防止する",
          purpose8: "当社のサービスでのあなたの体験をパーソナライズし、改善する"
        }
      },
      fileHandling: {
        title: "3. ファイルの取り扱い方法",
        processing: {
          title: "3.1. ファイル処理",
          description: "当社のサービスにアップロードされたファイルは、要求された変換または操作機能を提供するために当社のサーバーで処理されます。この処理は通常自動化されており、あなたのコンテンツの人間によるレビューは含まれません。"
        },
        storage: {
          title: "3.2. ファイルの保存と保持",
          temporary: {
            label: "一時保存：",
            description: "アップロードされたファイルは、当社のサービスを提供するために一時的にサーバーに保存されます。プレミアムユーザーで拡張ストレージオプションを持っていない限り、ファイルは24時間後に自動的に削除されます。"
          },
          converted: {
            label: "変換されたファイル：",
            description: "変換または処理された結果のファイルも一時的に保存され、24時間ダウンロード可能であり、その後自動的に削除されます。"
          }
        },
        security: {
          title: "3.3. ファイルのセキュリティ",
          description: "当社は、あなたのファイルが不正アクセス、開示、変更、または破壊から保護されるように設計された合理的なセキュリティ対策を講じます。ただし、インターネットを介した送信方法や電子保存方法は100％安全ではないことにご注意ください。"
        }
      },
      sharing: {
        title: "4. 情報の共有",
        description: "当社は以下のように情報を共有することがあります：",
        serviceProviders: {
          title: "4.1. サービスプロバイダ",
          description: "当社は、支払い処理、データ分析、メール配信、ホスティングサービス、カスタマーサービスなど、当社に代わってサービスを実行する第三者のベンダー、サービスプロバイダ、請負業者、または代理人とあなたの情報を共有することがあります。"
        },
        businessTransfers: {
          title: "4.2. 事業譲渡",
          description: "当社が合併、買収、資金調達、組織再編、破産、または企業資産の売却に関与する場合、あなたの情報はその取引の一部として譲渡されることがあります。"
        },
        legal: {
          title: "4.3. 法的要件",
          description: "法律により要求された場合、または公共機関（例：裁判所または政府機関）からの有効な要請に応じて、あなたの情報を開示することがあります。"
        }
      },
      cookies: {
        title: "5. クッキーとトラッキング技術",
        types: {
          title: "5.1. 使用するクッキーの種類",
          essential: {
            label: "必須クッキー：",
            description: "これらのクッキーは、サービスが正しく機能するために必要です。"
          },
          analytics: {
            label: "分析クッキー：",
            description: "これらのクッキーを使用して、ユーザーが当社のサービスとどのように対話しているかを分析し、機能とユーザー体験を向上させます。"
          },
          preference: {
            label: "プリファレンスクッキー：",
            description: "これらのクッキーにより、サービスがどのように動作するか、または見えるかを変更する情報を記憶することができます。たとえば、好みの言語や地域です。"
          }
        }
      },
      rights: {
        title: "6. あなたの権利と選択肢",
        description: "あなたの所在地によっては、個人情報に関する特定の権利を持つ場合があります：",
        options: {
          option1: "個人情報へのアクセスを要求する",
          option2: "不正確な情報の修正を要求する",
          option3: "情報の削除を要求する",
          option4: "当社による情報の処理に異議を唱える",
          purpose5: "処理の制限を要求する",
          option6: "データポータビリティを要求する",
          option7: "処理が同意に基づいている場合、いつでも同意を撤回する"
        }
      },
      contact: {
        title: "7. 連絡先情報",
        description: "このプライバシーポリシーまたは当社のデータ慣行について質問や懸念がある場合は、以下までご連絡ください：",
        email: {
          label: "メール：",
    ...
    acknowledgment: "MegaPDFを利用することで、あなたはこのプライバシーポリシーを読み、理解したことを認めます。",
    viewTerms: "利用規約を見る"
},
cookies: {
  title: "クッキーポリシー",
  ...
  overview: "概要",
  intro: "このクッキーポリシーは、クッキーとは何か、そして当社のウェブサイトでどのように使用しているかを説明します。このポリシーを読んで、クッキーとは何か、どのように使用しているか、使用しているクッキーの種類、そしてクッキーの設定を管理する方法を理解することをお勧めします。",
  
  tabs: {
    what: "クッキーとは",
    types: "クッキーの種類",
    how: "クッキーの使用方法",
    thirdParty: "サードパーティクッキー",
    manage: "クッキーの管理"
  },
  
  whatAre: {
    title: "クッキーとは？",
    description: "クッキーは、ウェブサイトを訪問した際にコンピューターやモバイルデバイスに保存される小さなテキストファイルです。ウェブサイトをより効率的に動作させ、ウェブサイトの所有者に情報提供するために広く使用されています。",
    purpose: "クッキーは、デバイスを認識し、パーソナライズされた体験を提供するために使用されます。また、アカウントのセキュリティを確保し、サービスの使用状況を分析し、マーケティング活動を支援するためにも使用されます。"
  },
  ...
  types: {
    ...
    essential: {
      title: "必須クッキー",
      description: "これらのクッキーは、ウェブサイトが正しく機能するために必要です。ページナビゲーションやウェブサイトのセキュアなエリアへのアクセスなどの基本的な機能を有効にします。これらのクッキーなしではウェブサイトは正しく機能しません。",
      examples: {
        session: "認証用セッションクッキー",
        csrf: "セキュリティ用のCSRFトークン",
        load: "負荷分散クッキー"
      }
    },
    functional: {
      title: "機能クッキー",
      description: "これらのクッキーは、ウェブサイトが強化された機能やパーソナライゼーションを提供できるようにします。これらは当社または当社のページに追加したサービスを提供するサードパーティプロバイダーによって設定される場合があります。",
      examples: {
        language: "言語設定クッキー",
        theme: "ユーザーインターフェースカスタマイズクッキー"
      }
    },
    analytics: {
      title: "分析クッキー",
      description: "これらのクッキーは、訪問者がウェブサイトとどのように対話するかを理解するのに役立ちます。訪問者数、バウンス率、トラフィックソースなどのメトリクスに関する情報を提供します。",
      examples: {
        ga: "Googleアナリティクスクッキー",
        heatmap: "ユーザーの行動追跡クッキー"
      }
    },
    advertising: {
      title: "広告クッキー",
      description: "これらのクッキーは、ウェブサイト間で訪問者を追跡するために使用されます。個々のユーザーに適切で魅力的な広告を表示し、パブリッシャーやサードパーティ広告主にとってより価値のあるものにすることを目的としています。"
    }
  },
  
  howWeUse: {
    title: "クッキーの使用方法",
    description: "クッキーはさまざまな理由で使用しています。以下を含みます：",
    purposes: {
      authentication: "ユーザーを認証し、ユーザーアカウントの不正使用を防ぐため",
      security: "サービスのセキュリティを強化するため",
      preferences: "あなたの好みや設定に関する情報を記憶するため",
      analytics: "ウェブサイトの使用方法を理解し、機能やユーザー体験を改善するため",
      features: "サービスの特定の機能や機能を有効にするため"
    }
  },
  
  thirdParty: {
    title: "サードパーティクッキー",
    description: "当社独自のクッキーに加えて、使用統計の報告、広告の配信などを行うためにさまざまなサードパーティクッキーも使用する場合があります。",
    providers: {
      analytics: "ウェブサイトの使用方法（最も頻繁に訪問するページなど）に関する情報を収集するために使用されます。この情報を使用してウェブサイトとサービスを改善します。",
      payment: "当社のプラットフォームでのサブスクリプションや購入のための支払い処理と詐欺防止に使用されます。",
      heatmap: "ヒートマップやセッション録画を通じて、ユーザーがページのさまざまな要素とどのように対話するかを理解するために使用されます。"
    }
  },
  
  manage: {
    title: "クッキー設定の管理",
    description: "ほとんどのウェブブラウザでは、設定の好みを介してクッキーを制御できます。ただし、ウェブサイトがクッキーを設定する能力を制限すると、全体的なユーザー体験に影響を与え、ウェブサイトの特定の機能が意図したとおりに動作しない可能性があります。",
    browser: {
      title: "ブラウザの制御",
      description: "ブラウザの設定を介してクッキーを管理できます。一般的なブラウザでの方法は以下の通りです：",
      chrome: "設定 > プライバシーとセキュリティ > クッキーとその他のサイトデータ",
      firefox: "オプション > プライバシーとセキュリティ > クッキーとサイトデータ",
      safari: "環境設定 > プライバシー > クッキーとウェブサイトデータ",
      edge: "設定 > クッキーとサイトの権限 > クッキーとサイトデータ"
    },
    warning: "必須クッキーを無効にすると、ウェブサイトの機能に影響を与え、一部の機能が正しく動作しない可能性があることに注意してください。"
  },
...
pdfTextEditor: {
  title: "PDFテキストエディター",
  description: "高度で使いやすいPDFテキストエディターツールを使用して、PDFドキュメント内のテキストを簡単に抽出、編集、修正し、正確な位置制御を行います。",
  noFileSelected: "PDFファイルが選択されていません - PDFドキュメントをアップロードして、テキスト編集をスムーズに開始してください",
  extractText: "PDFテキストコンテンツを即座に抽出して簡単な編集を可能にします",
  savePDF: "すべての変更を適用して編集済みのPDFドキュメントを保存",
  reset: "すべての変更を元のPDFコンテンツに即座にリセット",
  startOver: "新しいPDFファイルをアップロードしてテキスト編集を開始",
  editAnother: "別のPDFドキュメントを迅速かつ効率的に編集",
  pages: "複数ページ編集をサポートするPDFドキュメントページ",
  page: "ターゲットテキスト編集用の個別のPDFページ",
  textBlocks: "正確な編集が可能なPDFテキストブロック",
  pageInfo: "PDFページ情報と詳細な編集オプション",
  editText: "PDFテキストコンテンツを直接簡単に編集...",
  unsavedChanges: "PDFドキュメントに保存されていない変更が検出されました",
  extractSuccess: "PDFテキストがスムーズな編集のために正常に抽出されました",
  extractFailed: "PDFドキュメントからテキストを抽出できませんでした - 再試行してください",
  saveSuccess: "編集済みのPDFドキュメントがすべての更新を適用して正常に保存されました",
  saveFailed: "編集済みのPDFファイルの保存に失敗しました - 再試行してください",
  saveSuccessDesc: "編集済みのPDFドキュメントがすべての変更を適用して生成され、すぐにデバイスにダウンロードして共有または保存する準備ができています。",
  downloadEdited: "すべての変更を適用した編集済みのPDFファイルを今すぐダウンロード",
  noDataToSave: "現在、保存可能なPDFデータがありません",
  resetSuccess: "PDFドキュメントが元の状態に正常にリセットされました",
  resetFailed: "PDFを元のコンテンツにリセットできませんでした - 再試行してください",
  uploading: "PDFファイルを処理およびテキスト編集のためにアップロード中...",
  processing: "テキスト編集および修正のためにPDFドキュメントを処理中...",
  extractingText: "PDFファイルからテキストを自動的に抽出して編集準備中...",
  readyToEdit: "PDFドキュメントがスムーズなテキスト編集とカスタマイズの準備ができました",
  networkError: "PDF処理中にネットワークエラーが発生しました - 接続を確認してください",
  unknownError: "PDF編集プロセスで不明なエラーが発生しました - 再試行してください",
  tryAgain: "最適な結果を得るためにPDFドキュメントの編集を再度試みてください",
  dragAndDrop: "PDFファイルをドラッグアンドドロップして即座に編集を開始",
  dropHereDesc: "PDFファイルをここにドロップするか、クリックして参照し、簡単かつ自動的なテキスト抽出と編集を行います。私たちの高度なPDFエディターは、テキスト修正をシンプル、効率的、そしてすべてのユーザーにとってアクセス可能にし、毎回プロフェッショナルな品質の結果を保証します。",
  howToEdit: "PDFテキストをオンラインで迅速、簡単、正確に編集する方法",
  editInstructions: "ビジュアルエディターを使用して、PDFページに表示される通りに配置されたテキストを表示および編集するか、リストエディターに切り替えて整理された構造化されたテキスト編集を行います。任意のテキストブロックをクリックして選択し、コンテンツを簡単に修正し、元のレイアウトとフォーマットを維持しながらPDFドキュメントに正確な更新を保証します。",
  visualEditor: "正確で直感的なテキスト編集のためのビジュアルPDFテキストエディター",
  listEditor: "整理された構造化された編集のためのリストベースのPDFテキストエディター",
  editingPage: "高い精度で特定のPDFページを編集",
  previousPage: "編集を続けるために前のPDFページに移動",
  nextPage: "スムーズな編集のために次のPDFページに移動",
  editingBlock: "正確に特定のPDFテキストブロックを編集",
  editing: "リアルタイム更新でPDFコンテンツを積極的に編集",
  editTextContent: "PDFテキストコンテンツを直接正確に編集：",
  clickToClose: "ヘッダーをクリックしてPDFエディターインターフェースを迅速に閉じる",
  noTextBlocks: "このPDFページには編集用のテキストブロックが見つかりませんでした",
  quickJump: "ターゲット編集のために特定のPDFページに迅速にジャンプ",
  howTo: {
    title: "PDFドキュメントのテキストをオンラインで編集するステップごとのガイド",
    step1: {
      title: "テキスト編集のためにPDFドキュメントをアップロード",
      description: "PDFファイルを高度なエディターにアップロードして、すべてのテキスト要素を自動的に抽出し、スムーズで正確な編集と修正の準備をします。"
    },
    step2: {
      title: "PDFテキストコンテンツを直接かつ直感的に編集",
      description: "PDF内の任意のテキストブロックをクリックしてコンテンツを直接編集し、強力なPDFテキスト編集ツールで迅速、直感的、かつ正確な更新を行います。"
    },
    step3: {
      title: "PDFの変更を簡単に保存してダウンロード",
      description: "編集したテキストを保存して、すべての変更が適用された新しいPDFドキュメントを生成し、すぐにダウンロード、共有、またはプロフェッショナルな使用の準備をします。"
    }
  },
  features: {
    title: "高度なPDFテキストエディターツールの強力な機能",
    preserve: "プロフェッショナルで高品質な結果のために、元のPDFのフォーマット、レイアウト、テキスト位置を維持",
    visual: "リアルタイムプレビューで正確かつ直感的なPDF修正のためのビジュアルテキストブロック選択と編集",
    multipage: "複数ページのPDFドキュメントを完全にサポートし、すべてのページで包括的な編集を可能にします",
    fonts: "PDFテキスト編集とカスタマイズの正確な制御のための詳細なフォントとサイズ情報の表示"
  },
  useCases: {
    title: "PDFテキスト編集と修正の一般的な使用例",
    documentTranslation: {
      title: "PDFファイルのドキュメント翻訳",
      description: "元のレイアウト、フォーマット、デザインを維持しながら、PDFコンテンツを複数の言語に翻訳し、プロフェッショナルな多言語ドキュメントを作成します。"
    },
    contentCorrection: {
      title: "PDFドキュメントのコンテンツ修正",
      description: "既存のPDFファイルのタイポの修正、時代遅れの情報の更新、またはエラーの修正を迅速かつ正確に行います。"
    },
    templateCustomization: {
      title: "PDFテンプレートのカスタマイズと編集",
      description: "テキストフィールド、コンテンツエリア、その他の要素を編集して、特定の要件を満たすようにPDFテンプレートをカスタマイズします。"
    },
    rebrandingDocuments: {
      title: "PDFドキュメントの効率的なリブランディング",
      description: "会社名、住所、ロゴ、ブランド情報をPDFファイルで迅速かつプロフェッショナルに更新します。"
    }
  },
  relatedTools: {
    title: "生産性とドキュメント管理を強化するための関連PDFツール",
    convertPDF: {
      title: "PDFを編集可能なフォーマットに変換",
      description: "PDFファイルをWord、Excel、その他のフォーマットに変換して、さらなるカスタマイズと編集を行います。"
    },
    watermarkPDF: {
      title: "PDFドキュメントに透かしを追加",
      description: "ブランド、セキュリティ、またはプロフェッショナルな目的で、PDFファイルにテキストまたは画像の透かしを簡単に追加します。"
    },
    mergePDF: {
      title: "複数のPDFファイルを結合",
      description: "複数のPDFドキュメントを1つのファイルに結合して、効率的な整理、共有、管理を行います。"
    },
    splitPDF: {
      title: "PDFページを簡単に分割",
      description: "PDFドキュメントから特定のページを抽出して新しいファイルを作成またはコンテンツを効率的に再編成します。"
    }
  },
  seoContent: {
    title: "プロフェッショナルなドキュメントのための高度なPDFテキスト編集",
    paragraph1: "当社の高度なPDFテキストエディターは、PDFドキュメント向けにプロフェッショナルグレードのテキスト編集機能を提供します。基本的なPDFエディターとは異なり、当社のツールは、元のPDFの正確な位置、フォーマット、レイアウトを維持しながら、正確なテキスト修正を行い、すべてのユーザーに高品質な結果を提供します。",
    paragraph2: "最先端のアルゴリズムを利用して、当社のPDFエディターは、テキストブロック、フォントの詳細、位置データを比類のない精度で抽出します。これにより、編集済みのPDFが元のドキュメントのプロフェッショナルな外観と完全性を維持し、重要な更新に最適です。",
    paragraph3: "ビジネス、法的ドキュメント、フォーム、契約、または全体のデザインを損なうことなくテキスト変更が必要なPDFに最適です。プロフェッショナル、教育、または個人使用のために、直感的かつ強力な編集ツールを使用して、PDFテキストをオンラインで簡単に編集します。"
  },
  viewAllPDFTools: "包括的なドキュメント管理のためのすべてのPDFツールを表示"
}
}