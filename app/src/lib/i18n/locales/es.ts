...
export default {
  metadata: {
    title: "MegaPDF - Convertidor PDF gratuito, editor, OCR y desbloquear PDF",
    template: "%s | MegaPDF - Herramientas PDF",
    description: "Convierte, edita, desbloquea, comprime, une, divide y aplica OCR a PDF con MegaPDF. Herramientas PDF gratuitas y rápidas en línea—sin necesidad de descargas.",
    keywords: "convertidor PDF, editor PDF, OCR en línea, desbloquear PDF, comprimir PDF, unir PDF, dividir PDF, herramientas PDF gratuitas, editor PDF en línea, MegaPDF"
  },
  nav: {
    tools: "Herramientas",
    company: "Compañía",
    ...
    appStores: "Obtener la aplicación MegaPDF",
  ...
  auth: {
    ...
    checkYourInbox: "Revisa tu bandeja de entrada para completar el registro",
    verificationEmailSentTo: "Hemos enviado un correo electrónico de verificación a",
    pleaseClickLink: " Por favor, haz clic en el enlace del correo para verificar tu cuenta.",
    checkSpamFolder: "Revisa tu carpeta de spam o",
    alreadyVerified: "¿Ya verificado?",
    oAuthAccountNotLinked: "Este correo electrónico ya está asociado con otro método de inicio de sesión. Por favor, inicia sesión con el método que usaste originalmente.",
  ...
  login: {
    ...
    termsAndPrivacy: "Al iniciar sesión, aceptas nuestros <termsLink>Términos de Servicio</termsLink> y <privacyLink>Política de Privacidad</privacyLink>.",
    footer: "© 2025 MegaPDF. Todos los derechos reservados."
  },
  dashboard: {
    title: "Tablero",
    overview: "Resumen",
  ...
  subscription: {
    ...
    success: {
      ...
      message: "¡Gracias por suscribirte a MegaPDF! Ahora tienes acceso a todas las funciones de tu nivel de suscripción.",
      cta: "Ir al Panel",
      seo: {
        title: "Suscripción Activada Exitosamente - MegaPDF",
        description: "Tu suscripción a MegaPDF ha sido activada. Explora todas las funciones premium ahora disponibles para ti."
      }
    },
    cancel: {
      ...
      cta: "Volver a Planes",
      seo: {
        title: "Suscripción Cancelada - MegaPDF",
  ...
  features: {
    title: "Herramientas y Funciones Avanzadas de PDF | MegaPDF",
    description: "Explora la suite completa de herramientas y funciones de PDF de MegaPDF para la gestión, conversión, edición de documentos y más.",

    hero: {
      title: "Herramientas y Funciones Avanzadas de PDF",
      description: "Descubre la suite completa de herramientas y funciones que hacen de MegaPDF la solución definitiva para todas tus necesidades de gestión documental."
    },
    ...
    mobile: {
      title: "Aplicación Móvil MegaPDF",
      description: "Lleva las potentes herramientas de PDF de MegaPDF contigo en movimiento. Nuestra aplicación móvil ofrece la misma funcionalidad robusta en una interfaz amigable para móviles.",
      feature1: {
    ...
    testimonials: {
      ...
      quote1: "MegaPDF ha revolucionado la forma en que nuestro equipo maneja documentos. La funcionalidad OCR es increíblemente precisa y el procesamiento por lotes nos ahorra horas cada semana.",
      name1: "Sarah Johnson",
      title1: "Gerente de Operaciones",
      quote2: "La integración del API fue impecable. Hemos integrado MegaPDF en nuestro flujo de trabajo y la diferencia en eficiencia es notable. Su equipo de soporte también es de primera.",
      name2: "David Chen",
      title2: "Líder Técnico",
      quote3: "Como pequeña empresaria, los precios asequibles y el conjunto completo de herramientas hacen de MegaPDF un valor increíble. Me encanta especialmente la aplicación móvil que me permite manejar documentos en movimiento.",
      name3: "María García",
  ...
  splitPdf: {
    ...
    faq: {
      ...
      q1: {
        ...
        answer: "Todos los archivos subidos y generados se eliminan automáticamente de nuestros servidores después de 1 horas para tu privacidad y seguridad."
      },
      q2: {
  ...
  compressPdf: {
    ...
    faq: {
      ...
      secure: {
        ...
        answer: "Sí, tus datos están seguros. Todos los archivos PDF se procesan en línea de forma segura y se eliminan automáticamente después de 1 horas. Ya sea que uses Windows o Linux, tu archivo está encriptado y nunca se comparte."
      },
      fileLimits: {
  ...
  contact: {
    ...
    faq: {
      ...
      responseTime: {
        ...
        answer: "Tratamos de responder a todas las consultas dentro de 1-48 horas hábiles. Durante períodos de alta demanda, puede tomar hasta 72 horas."
      },
      technicalSupport: {
  ...
  about: {
    hero: {
      ...
      description: "MegaPDF nació de una idea simple: hacer que la gestión de documentos sea fluida, eficiente y accesible para todos. Creemos en transformar la forma en que las personas interactúan con los documentos digitales."
    },
    story: {
      title: "Nuestra historia",
      paragraph1: "Fundada en 2022, MegaPDF surgió de la frustración de lidiar con herramientas PDF complejas y poco intuitivas. Nuestros fundadores, entusiastas de la tecnología y expertos en gestión documental, vieron una oportunidad para crear una solución que fuera tanto poderosa como fácil de usar.",
    ...
    team: {
      ...
      description: "MegaPDF está impulsado por un equipo pequeño y dedicado enfocado en crear las mejores herramientas PDF posibles para nuestros usuarios.",
      member1: {
        name: "Cakra",
  ...
  faq: {
    ...
    general: {
      question1: "¿Qué es MegaPDF?",
      answer1: "MegaPDF es una plataforma en línea integral para la gestión y conversión de PDFs. Nuestras herramientas te ayudan a convertir, editar, fusionar, dividir, comprimir y asegurar tus documentos PDF a través de una interfaz web intuitiva o API.",
      question2: "¿Necesito crear una cuenta para usar MegaPDF?",
      ...
      question3: "¿Están mis datos seguros en MegaPDF?",
      answer3: "Sí, todos los archivos se procesan de forma segura en nuestros servidores con cifrado. No compartimos tus archivos con terceros, y los archivos se eliminan automáticamente de nuestros servidores después del procesamiento (dentro de las 1 horas). Para más detalles, consulta nuestra Política de Privacidad.",
      question4: "¿Qué dispositivos y navegadores soporta MegaPDF?",
      answer4: "MegaPDF funciona en todos los navegadores modernos, incluidos Chrome, Firefox, Safari y Edge. Nuestra plataforma es totalmente responsiva y funciona en computadoras de escritorio, tabletas y dispositivos móviles."
    },
    conversion: {
      question1: "¿Qué tipos de archivos puedo convertir hacia y desde?",
      answer1: "MegaPDF permite convertir PDFs a muchos formatos, incluidos Word (DOCX), Excel (XLSX), PowerPoint (PPTX), imágenes (JPG, PNG), HTML y texto plano. También puedes convertir estos formatos de vuelta a PDF.",
  ...
  security: {
    title: "Seguridad y Privacidad en MegaPDF",
    ...
    sections: {
      ...
      temporaryStorage: {
        ...
        description: "Los archivos se eliminan automáticamente en 1 horas después del procesamiento. No conservamos tus documentos más tiempo del necesario."
      },
      access: {
    ...
    tabContent: {
      ...
      compliance: {
        ...
        approach: {
          ...
          description: "MegaPDF está diseñado con privacidad y seguridad por diseño. Revisamos y actualizamos nuestras prácticas regularmente para cumplir con regulaciones en evolución."
        },
        gdpr: {
    ...
    retention: {
      ...
      documents: {
        ...
        description: "Los archivos se eliminan automáticamente de nuestros servidores en 1 horas después del procesamiento. No guardamos copias de tus documentos a menos que optes explícitamente por funciones de almacenamiento disponibles en planes de pago."
      },
      account: {
    ...
    faq: {
      dataCollection: {
        question: "¿Qué datos personales recopila MegaPDF?",
      ...
      documentStorage: {
        ...
        answer: "Los documentos se eliminan automáticamente de nuestros servidores después del procesamiento, normalmente en 1 horas. Para suscriptores de pago, hay opciones de almacenamiento de documentos, pero son solo funciones opcionales."
      },
      thirdParty: {
  ...
  developer: {
    ...
    description: "Integre las potentes herramientas de PDF de MegaPDF en sus aplicaciones con nuestra API RESTful",
    tabs: {
    ...
    authentication: {
      ...
      apiKeys: {
        title: "Claves API",
        description: "Todas las solicitudes a la API de MegaPDF requieren autenticación mediante una clave API. ¡Su clave API tiene muchos privilegios, así que asegúrese de mantenerla segura!"
      },
      howTo: {
    ...
    overview: {
      ...
      intro: "La API de MegaPDF le permite integrar nuestras capacidades de procesamiento de PDF directamente en sus aplicaciones. Con una interfaz RESTful simple, puede convertir, comprimir, combinar, dividir y realizar otras operaciones en PDFs programáticamente.",
      features: {
      ...
      startSteps: "Para comenzar con la API de MegaPDF:",
  ...
  pricing: {
    description: "Elige el plan adecuado para tus necesidades de PDF. MegaPDF ofrece opciones de precios flexibles desde gratuito hasta empresarial, con las funciones que necesitas.",
    ...
    features: {
      ...
      amount: {
        free: "500 operaciones",
        basic: "5,000 operaciones",
        pro: "50,000 operaciones",
        enterprise: "500,000 operaciones"
      },
  ...
  ocrPdf: {
    ...
    faq1Answer: 'Sí, nos tomamos muy en serio la seguridad de los datos. Todas las cargas y el procesamiento de archivos se realizan en servidores seguros. Tus archivos se eliminan automáticamente después de 1 horas y no utilizamos tus documentos para ningún otro propósito que no sea proporcionar el servicio OCR.',
  ...
  terms: {
    ...
    meta: {
      title: "Términos de Servicio | MegaPDF - Herramientas PDF",
      description: "Términos de Servicio para las herramientas PDF de MegaPDF. Lea acerca de nuestros términos y condiciones para el uso de nuestros servicios."
    },
    lastUpdated: "Última actualización: 18 de marzo de 2025",
    welcome: "Bienvenido a MegaPDF. Por favor, lea estos Términos de Servicio cuidadosamente antes de usar nuestro sitio web, aplicaciones móviles y servicios (colectivamente, los Servicios).",
    sections: {
      acceptance: {
        title: "1. Aceptación de los Términos",
        content: "Al acceder o usar nuestros Servicios, usted acepta estar sujeto a estos Términos. Si no está de acuerdo con estos Términos, por favor no utilice nuestros Servicios."
      },
      services: {
        title: "2. Descripción de los Servicios",
        description: "MegaPDF proporciona herramientas para la conversión, manipulación y optimización de documentos PDF, incluyendo, pero no limitado a:",
        features: {
          feature1: "Conversión de PDFs a varios formatos (DOCX, XLSX, JPG, etc.)",
          feature2: "Conversión de documentos a formato PDF",
          feature3: "Compresión de archivos PDF",
          feature4: "Fusión de múltiples archivos PDF",
          feature5: "División de archivos PDF en documentos separados",
          feature6: "Rotación de páginas PDF",
          feature7: "Añadir marcas de agua a archivos PDF",
          feature8: "Otras funciones de procesamiento de PDF"
        }
      },
      account: {
        title: "3. Registro de Cuenta",
        registration: "3.1. Algunas funciones de nuestros Servicios pueden requerir que se registre para obtener una cuenta. Al registrarse, usted acepta proporcionar información precisa, actual y completa.",
        responsibility: "3.2. Usted es responsable de mantener la confidencialidad de las credenciales de su cuenta y de todas las actividades que ocurran bajo su cuenta.",
        security: "3.3. Usted acepta notificarnos inmediatamente de cualquier uso no autorizado de su cuenta o cualquier otra violación de seguridad."
      },
      obligations: {
        title: "4. Obligaciones del Usuario",
        lawfulUse: {
          title: "4.1. Uso Legal.",
          description: "Usted acepta usar nuestros Servicios solo para fines legales y de acuerdo con estos Términos. Usted acepta no usar nuestros Servicios:",
          restrictions: {
            restriction1: "De ninguna manera que viole cualquier ley o regulación federal, estatal, local o internacional aplicable",
            restriction2: "Para transmitir cualquier material que contenga virus, troyanos, gusanos, malware u otro código dañino",
            restriction3: "Para infringir o violar nuestros derechos de propiedad intelectual o los derechos de propiedad intelectual de otros"
          }
        },
        content: {
          title: "4.2. Propiedad y Responsabilidad del Contenido.",
          description: "Usted conserva todos los derechos de propiedad sobre los archivos que carga en nuestros Servicios. Usted es el único responsable del contenido de sus archivos y de la legalidad de cargar, procesar y descargar dicho contenido."
        },
        sensitiveInfo: {
          title: "4.3. Sin Información Sensible.",
          description: "Usted acepta no cargar archivos que contengan información personal sensible, como números de seguridad social, información de cuentas financieras, información de salud o cualquier otra información sujeta a protección regulatoria específica."
        }
      },
      privacy: {
        title: "5. Privacidad",
        description: {
          before: "Su privacidad es importante para nosotros. Nuestra ",
          link: "Política de Privacidad",
          after: ", que se incorpora a estos Términos por referencia, explica cómo recolectamos, usamos y divulgamos información sobre usted."
        }
      },
      intellectual: {
        ...
        ownership: {
          ...
          description: "Los Servicios, incluyendo todo el contenido, características y funcionalidades, son propiedad nuestra, de nuestros licenciantes u otros proveedores y están protegidos por leyes de derechos de autor, marcas registradas y otras leyes de propiedad intelectual."
        },
        license: {
          title: "6.2. Licencia Limitada para Uso.",
          description: "Le otorgamos una licencia limitada, no exclusiva, no transferible y revocable para usar nuestros Servicios para sus fines personales o comerciales internos."
        }
      },
      disclaimers: {
        title: "7. Descargos de Responsabilidad y Limitaciones de Responsabilidad",
        asis: {
          title: "7.1. Servicio Proporcionado Tal Cual.",
          description: "Los Servicios se proporcionan TAL CUAL y SEGÚN DISPONIBILIDAD, sin garantías de ningún tipo, ya sean expresas o implícitas, incluyendo, pero no limitado a, garantías implícitas de comerciabilidad, aptitud para un propósito particular o no infracción."
        },
        liability: {
          title: "7.2. Limitación de Responsabilidad.",
          description: "En la máxima medida permitida por la ley aplicable, en ningún caso nosotros o nuestras afiliadas, proveedores de servicios, empleados, agentes, oficiales o directores seremos responsables por daños de ningún tipo, bajo ninguna teoría legal, que surjan de o en conexión con su uso o incapacidad para usar los Servicios, incluyendo cualquier daño directo, indirecto, especial, incidental, consecuente o punitivo."
        }
      },
      termination: {
        title: "8. Vigencia y Terminación",
        duration: "8.1. Estos Términos permanecerán en pleno vigor y efecto mientras usted utilice los Servicios.",
        rights: "8.2. Podemos terminar o suspender su acceso a todos o cualquier parte de los Servicios, con o sin notificación, por cualquier conducta que, a nuestro exclusivo criterio, consideremos que viola estos Términos o es perjudicial para otros usuarios de los Servicios, nosotros o terceros, o por cualquier otra razón.",
        effect: "8.3. Tras la terminación, su derecho a usar los Servicios cesará inmediatamente."
      },
      changes: {
        title: "9. Cambios a los Términos",
        description: "Nos reservamos el derecho de modificar estos Términos en cualquier momento. Notificaremos cualquier cambio material publicando los nuevos Términos en los Servicios y actualizando la fecha de última actualización. Su uso continuado de los Servicios después de dichos cambios constituye su aceptación de los nuevos Términos."
      },
      contact: {
        title: "10. Información de Contacto",
        description: "Si tiene alguna pregunta sobre estos Términos, contáctenos en:",
        email: {
    ...
    agreement: "Al usar MegaPDF, usted reconoce que ha leído, entendido y acepta estar sujeto a estos Términos de Servicio.",
    viewPrivacyPolicy: "Ver Política de Privacidad"
  },
  privacy: {
    title: "Política de Privacidad",
    meta: {
      title: "Política de Privacidad | MegaPDF - Herramientas PDF",
      description: "Política de Privacidad para las herramientas PDF de MegaPDF. Conozca cómo manejamos sus datos y protegemos su privacidad."
    },
    lastUpdated: "Última actualización: 18 de marzo de 2025",
    introduction: "Esta Política de Privacidad describe cómo MegaPDF recopila, utiliza y divulga información cuando utiliza nuestro sitio web, aplicaciones móviles y servicios (colectivamente, los Servicios).",
    sections: {
      informationWeCollect: {
        title: "1. Información que recopilamos",
        description: "Recopilamos varios tipos de información de y sobre los usuarios de nuestros Servicios:"
      },
      informationYouProvide: {
        title: "1.1. Información que nos proporciona",
        account: {
          label: "Información de la cuenta:",
          description: "Cuando se registra para obtener una cuenta, recopilamos su nombre, dirección de correo electrónico y contraseña."
        },
        payment: {
          label: "Información de pago:",
          description: "Si adquiere servicios premium, recopilamos información de pago, que puede incluir detalles de la tarjeta de crédito, dirección de facturación y otra información financiera. El procesamiento de pagos lo manejan nuestros procesadores de pagos de terceros, y no almacenamos información completa de tarjetas de crédito en nuestros servidores."
        },
        files: {
          label: "Archivos y contenido:",
          description: "Recopilamos los archivos que sube a nuestros Servicios para su procesamiento (como PDFs y otros documentos)."
        },
        communications: {
          label: "Comunicaciones:",
          description: "Si se pone en contacto con nosotros directamente, podemos recopilar información sobre su comunicación y cualquier información adicional que proporcione."
        }
      },
      automaticInformation: {
        title: "1.2. Información que recopilamos automáticamente",
        usage: {
          label: "Datos de uso:",
          description: "Recopilamos información sobre cómo interactúa con nuestros Servicios, incluidas las funciones que utiliza, el tiempo que pasa en los Servicios y las páginas que visita."
        },
        device: {
          label: "Información del dispositivo y conexión:",
          description: "Recopilamos información sobre su dispositivo y conexión a Internet, incluida su dirección IP, tipo de navegador, sistema operativo e identificadores de dispositivo."
        },
        cookies: {
          label: "Cookies y tecnologías similares:",
          description: "Utilizamos cookies y tecnologías de seguimiento similares para rastrear la actividad en nuestros Servicios y mantener cierta información. Para obtener más información sobre nuestro uso de cookies, consulte la Sección 5 a continuación."
        }
      },
      howWeUse: {
        title: "2. Cómo usamos su información",
        description: "Usamos la información que recopilamos para diversos fines, incluidos:",
        purposes: {
          purpose1: "Proporcionar, mantener y mejorar nuestros Servicios",
          purpose2: "Procesar y completar transacciones, y enviar información relacionada, incluidas confirmaciones",
          purpose3: "Enviar información administrativa, como actualizaciones, alertas de seguridad y mensajes de soporte",
          purpose4: "Responder a sus comentarios, preguntas y solicitudes, y proporcionar servicio al cliente",
          purpose5: "Comunicarnos con usted sobre productos, servicios, ofertas, promociones y eventos",
          purpose6: "Monitorear y analizar tendencias, uso y actividades en relación con nuestros Servicios",
          purpose7: "Detectar, investigar y prevenir transacciones fraudulentas y otras actividades ilegales",
          purpose8: "Personalizar y mejorar su experiencia con nuestros Servicios"
        }
      },
      fileHandling: {
        title: "3. Cómo manejamos sus archivos",
        processing: {
          title: "3.1. Procesamiento de archivos",
          description: "Los archivos que sube a nuestros Servicios se procesan en nuestros servidores para proporcionar la funcionalidad de conversión o manipulación solicitada. Este procesamiento suele ser automatizado y no implica una revisión humana de su contenido."
        },
        storage: {
          title: "3.2. Almacenamiento y retención de archivos",
          temporary: {
            label: "Almacenamiento temporal:",
            description: "Los archivos subidos se almacenan temporalmente en nuestros servidores para proporcionar nuestros Servicios. Los archivos se eliminan automáticamente después de 24 horas, a menos que sea un usuario premium con opciones de almacenamiento extendido."
          },
          converted: {
            label: "Archivos convertidos:",
            description: "Los archivos convertidos o procesados resultantes también se almacenan temporalmente y están disponibles para su descarga durante 24 horas, después de lo cual se eliminan automáticamente."
          }
        },
        security: {
          title: "3.3. Seguridad de los archivos",
          description: "Implementamos medidas de seguridad razonables diseñadas para proteger sus archivos contra accesos no autorizados, divulgación, alteración o destrucción. Sin embargo, tenga en cuenta que ningún método de transmisión por Internet o de almacenamiento electrónico es 100% seguro."
        }
      },
      sharing: {
        title: "4. Compartir información",
        description: "Podemos compartir información de la siguiente manera:",
        serviceProviders: {
          title: "4.1. Proveedores de servicios",
          description: "Podemos compartir su información con proveedores, contratistas o agentes de terceros que realizan servicios en nuestro nombre, como procesamiento de pagos, análisis de datos, entrega de correo electrónico, servicios de alojamiento y servicio al cliente."
        },
        businessTransfers: {
          title: "4.2. Transferencias comerciales",
          description: "Si estamos involucrados en una fusión, adquisición, financiamiento, reorganización, quiebra o venta de activos de la empresa, su información puede transferirse como parte de esa transacción."
        },
        legal: {
          title: "4.3. Requisitos legales",
          description: "Podemos divulgar su información si así lo requiere la ley o en respuesta a solicitudes válidas de autoridades públicas (por ejemplo, un tribunal o una agencia gubernamental)."
        }
      },
      cookies: {
        title: "5. Cookies y tecnologías de seguimiento",
        types: {
          title: "5.1. Tipos de cookies que utilizamos",
          essential: {
            label: "Cookies esenciales:",
            description: "Estas cookies son necesarias para que los Servicios funcionen correctamente."
          },
          analytics: {
            label: "Cookies analíticas:",
            description: "Utilizamos estas cookies para analizar cómo los usuarios interactúan con nuestros Servicios, lo que nos ayuda a mejorar la funcionalidad y la experiencia del usuario."
          },
          preference: {
            label: "Cookies de preferencia:",
            description: "Estas cookies nos permiten recordar información que cambia la forma en que los Servicios se comportan o se ven, como su idioma o región preferida."
          }
        }
      },
      rights: {
        title: "6. Sus derechos y opciones",
        description: "Dependiendo de su ubicación, puede tener ciertos derechos con respecto a su información personal:",
        options: {
          option1: "Solicitar acceso a su información personal",
          option2: "Solicitar la corrección de información inexacta",
          option3: "Solicitar la eliminación de su información",
          option4: "Objetar nuestro procesamiento de su información",
          option5: "Solicitar la restricción del procesamiento",
          option6: "Solicitar la portabilidad de datos",
          option7: "Retirar el consentimiento en cualquier momento, cuando el procesamiento se base en el consentimiento"
        }
      },
      contact: {
        title: "7. Información de contacto",
        description: "Si tiene alguna pregunta o inquietud sobre esta Política de Privacidad o nuestras prácticas de datos, contáctenos en:",
        email: {
          label: "Correo electrónico:",
    ...
    acknowledgment: "Al usar MegaPDF, usted reconoce que ha leído y entendido esta Política de Privacidad.",
...
cookies: {
  ...
  overview: "Resumen",
  intro: "Esta Política de Cookies explica qué son las cookies y cómo las utilizamos en nuestro sitio web. Recomendamos que lea esta política para entender qué son las cookies, cómo las usamos, los tipos de cookies que utilizamos y cómo puede gestionar sus preferencias de cookies.",
  
  tabs: {
    what: "Qué son las Cookies",
    types: "Tipos de Cookies",
    how: "Cómo Usamos las Cookies",
  ...
  whatAre: {
    ...
    description: "Las cookies son pequeños archivos de texto que se almacenan en su computadora o dispositivo móvil cuando visita un sitio web. Se utilizan ampliamente para hacer que los sitios web funcionen de manera más eficiente y proporcionar información a los propietarios del sitio web.",
    purpose: "Las cookies nos permiten reconocer su dispositivo y ofrecerle una experiencia personalizada. También se utilizan para ayudar a garantizar la seguridad de su cuenta, analizar el uso de nuestro servicio y asistir en nuestros esfuerzos de marketing."
  },
  ...
  types: {
    ...
    essential: {
      ...
      description: "Estas cookies son necesarias para que el sitio web funcione correctamente. Habilitan funciones básicas como la navegación de páginas y el acceso a áreas seguras del sitio web. El sitio web no puede funcionar correctamente sin estas cookies.",
      examples: {
        session: "Cookies de sesión para autenticación",
        csrf: "Tokens CSRF para seguridad",
        load: "Cookies de balanceo de carga"
      }
    },
    functional: {
      title: "Cookies Funcionales",
      description: "Estas cookies permiten al sitio web proporcionar una funcionalidad mejorada y personalización. Pueden ser establecidas por nosotros o por proveedores de terceros cuyos servicios hemos añadido a nuestras páginas.",
      examples: {
        language: "Cookies de preferencia de idioma",
        theme: "Cookies de personalización de la interfaz de usuario"
      }
    },
    analytics: {
      title: "Cookies Analíticas",
      description: "Estas cookies nos ayudan a entender cómo interactúan los visitantes con nuestro sitio web. Proporcionan información sobre métricas como el número de visitantes, la tasa de rebote, la fuente de tráfico, etc.",
      examples: {
        ga: "Cookies de Google Analytics",
        heatmap: "Cookies de seguimiento del comportamiento del usuario"
      }
    },
    advertising: {
      title: "Cookies Publicitarias",
      description: "Estas cookies se utilizan para rastrear a los visitantes a través de sitios web. La intención es mostrar anuncios que sean relevantes y atractivos para el usuario individual y, por lo tanto, más valiosos para los editores y anunciantes de terceros."
    }
  },
  
  howWeUse: {
    title: "Cómo Usamos las Cookies",
    description: "Usamos cookies por una variedad de razones, incluyendo:",
    purposes: {
      authentication: "Para autenticar a los usuarios y prevenir el uso fraudulento de cuentas de usuario",
      security: "Para mejorar la seguridad de nuestro servicio",
      preferences: "Para recordar información sobre sus preferencias y configuraciones",
      analytics: "Para ayudarnos a entender cómo usa nuestro sitio web, lo que nos permite mejorar la funcionalidad y la experiencia del usuario",
      features: "Para habilitar ciertas características y funcionalidades de nuestro servicio"
    }
  },
  
  thirdParty: {
    title: "Cookies de Terceros",
    description: "Además de nuestras propias cookies, también podemos usar varias cookies de terceros para reportar estadísticas de uso, entregar anuncios, y así sucesivamente.",
    providers: {
      analytics: "Se utilizan para recopilar información sobre cómo usa nuestro sitio web, incluidas las páginas que visita con más frecuencia. Usamos esta información para mejorar nuestro sitio web y servicios.",
      payment: "Se utilizan para procesar pagos y prevenir fraudes para suscripciones y compras en nuestra plataforma.",
      heatmap: "Se utilizan para entender cómo interactúan los usuarios con diferentes elementos de nuestras páginas a través de mapas de calor y grabaciones de sesiones."
    }
  },
  
  manage: {
    title: "Gestionar sus Preferencias de Cookies",
    description: "La mayoría de los navegadores web le permiten controlar las cookies a través de sus preferencias de configuración. Sin embargo, si limita la capacidad de los sitios web para establecer cookies, puede afectar su experiencia general de usuario y ciertas funciones de nuestro sitio web pueden no funcionar como se espera.",
    browser: {
      title: "Controles del Navegador",
      description: "Puede gestionar las cookies a través de la configuración de su navegador. Aquí le mostramos cómo hacerlo en navegadores populares:",
      ...
      edge: "Configuración > Cookies y permisos de sitios > Cookies y datos de sitios"
    },
    warning: "Tenga en cuenta que deshabilitar las cookies esenciales afectará la funcionalidad de nuestro sitio web, y ciertas funciones pueden no funcionar correctamente."
  },
...
pdfTextEditor: {
  ...
  description: "Extrae, edita y modifica texto en documentos PDF sin esfuerzo con control de posicionamiento preciso utilizando nuestra herramienta avanzada y fácil de usar de editor de texto PDF.",
  noFileSelected: "No se ha seleccionado ningún archivo PDF - Sube tu documento PDF para comenzar a editar texto sin problemas",
  extractText: "Extrae el contenido de texto PDF al instante para una edición fácil",
  savePDF: "Guarda tu documento PDF editado con todos los cambios aplicados",
  reset: "Restablece todos los cambios al contenido original del PDF al instante",
  startOver: "Sube un nuevo archivo PDF para comenzar a editar texto",
  editAnother: "Edita otro documento PDF de forma rápida y eficiente",
  pages: "Páginas del documento PDF para soporte de edición multipágina",
  page: "Página individual de PDF para edición de texto específica",
  textBlocks: "Bloques de texto PDF disponibles para edición precisa",
  pageInfo: "Información de la página PDF y opciones de edición detalladas",
  editText: "Edita el contenido de texto PDF directamente con facilidad...",
  unsavedChanges: "Se han detectado cambios no guardados en tu documento PDF",
  extractSuccess: "Texto PDF extraído con éxito para una edición sin problemas",
  extractFailed: "Error al extraer texto del documento PDF - Inténtalo de nuevo",
  saveSuccess: "Documento PDF editado guardado con éxito con todas las actualizaciones",
  saveFailed: "Error al guardar el archivo PDF editado - Por favor, inténtalo de nuevo",
  saveSuccessDesc: "Tu documento PDF editado ha sido generado con todos los cambios aplicados y está listo para descargar inmediatamente en tu dispositivo para compartir o almacenar.",
  downloadEdited: "Descarga tu archivo PDF editado ahora con todos los cambios",
  noDataToSave: "No hay datos PDF disponibles para guardar en este momento",
  resetSuccess: "Documento PDF restablecido con éxito a su estado original",
  resetFailed: "Error al restablecer el PDF al contenido original - Inténtalo de nuevo",
  uploading: "Subiendo tu archivo PDF para procesamiento y edición de texto...",
  processing: "Procesando tu documento PDF para edición y modificación de texto...",
  extractingText: "Extrayendo texto de tu archivo PDF automáticamente para edición...",
  readyToEdit: "Tu documento PDF está listo para edición y personalización de texto sin problemas",
  networkError: "Error de red durante el procesamiento del PDF - Comprueba tu conexión",
  unknownError: "Error desconocido en el proceso de edición de PDF - Por favor, inténtalo de nuevo",
  tryAgain: "Intenta editar tu documento PDF de nuevo para obtener los mejores resultados",
  dragAndDrop: "Arrastra y suelta tu archivo PDF para comenzar a editar al instante",
  dropHereDesc: "Suelta tu archivo PDF aquí o haz clic para buscar una extracción y edición de texto fácil y automática. Nuestro editor de PDF avanzado hace que la modificación de texto sea simple, eficiente y accesible para todos los usuarios, garantizando resultados de calidad profesional cada vez.",
  howToEdit: "Cómo editar texto PDF en línea de forma rápida, fácil y precisa",
  editInstructions: "Utiliza el Editor Visual para ver y editar texto posicionado exactamente como aparece en la página PDF, o cambia al Editor de Lista para una edición de texto organizada y estructurada. Haz clic en cualquier bloque de texto para seleccionarlo y modificar el contenido sin esfuerzo, asegurando actualizaciones precisas en tu documento PDF mientras mantienes su diseño y formato original.",
  visualEditor: "Editor de texto PDF visual para edición de texto precisa e intuitiva",
  listEditor: "Editor de texto PDF basado en lista para edición organizada y estructurada",
  editingPage: "Editando una página específica de PDF con alta precisión",
  previousPage: "Navega a la página anterior del PDF para continuar editando",
  nextPage: "Navega a la página siguiente del PDF para una edición sin problemas",
  editingBlock: "Editando un bloque de texto específico de PDF con precisión",
  editing: "Editando activamente contenido PDF con actualizaciones en tiempo real",
  editTextContent: "Edita el contenido de texto PDF directamente con precisión:",
  clickToClose: "Haz clic en el encabezado para cerrar rápidamente la interfaz del editor PDF",
  noTextBlocks: "No se encontraron bloques de texto en esta página PDF para editar",
  quickJump: "Salta rápidamente a una página específica de PDF para edición específica",
  howTo: {
    title: "Guía paso a paso para editar texto en documentos PDF en línea",
    step1: {
      title: "Sube tu documento PDF para editar texto",
      description: "Sube tu archivo PDF a nuestro editor avanzado para extraer automáticamente todos los elementos de texto, preparándolos para una edición y modificación precisa y sin problemas."
    },
    step2: {
      title: "Edita el contenido de texto PDF directamente e intuitivamente",
      description: "Haz clic en cualquier bloque de texto dentro del PDF para editar su contenido directamente, haciendo actualizaciones rápidas, intuitivas y precisas con nuestras potentes herramientas de edición de texto PDF."
    },
    step3: {
      title: "Guarda los cambios de tu PDF fácilmente y descarga",
      description: "Guarda tu texto editado para generar un nuevo documento PDF con todos los cambios aplicados, listo para descargar, compartir o usar profesionalmente de inmediato."
    }
  },
  features: {
    title: "Potentes características de nuestra herramienta avanzada de editor de texto PDF",
    preserve: "Preserva el formato, diseño y posicionamiento de texto original del PDF para resultados profesionales y de alta calidad",
    visual: "Selección y edición visual de bloques de texto para modificaciones de PDF precisas e intuitivas con vistas previas en tiempo real",
    multipage: "Soporte completo para documentos PDF multipágina, permitiendo una edición exhaustiva en todas las páginas",
    fonts: "Muestra información detallada de fuente y tamaño para un control preciso sobre la edición y personalización de texto PDF"
  },
  useCases: {
    title: "Casos de uso comunes para edición y modificación de texto PDF",
    documentTranslation: {
      title: "Traducción de documentos para archivos PDF",
      description: "Traduce contenido PDF a múltiples idiomas manteniendo el diseño, formato y diseño original para documentos profesionales y multilingües."
    },
    contentCorrection: {
      title: "Corrección de contenido en documentos PDF",
      description: "Corrige fácilmente errores tipográficos, actualiza información obsoleta o corrige errores en archivos PDF existentes con precisión y velocidad."
    },
    templateCustomization: {
      title: "Personalización y edición de plantillas PDF",
      description: "Personaliza plantillas PDF editando campos de texto, áreas de contenido y otros elementos para cumplir con tus requisitos específicos."
    },
    rebrandingDocuments: {
      title: "Re-branding eficiente de documentos PDF",
      description: "Actualiza nombres de empresas, direcciones, logos e información de marca en archivos PDF de forma rápida y profesional."
    }
  },
  relatedTools: {
    title: "Herramientas PDF relacionadas para mayor productividad y gestión de documentos",
    convertPDF: {
      title: "Convertir PDF a formatos editables",
      description: "Convierte tus archivos PDF a formatos editables como Word, Excel u otros formatos para mayor personalización y edición."
    },
    watermarkPDF: {
      title: "Agregar marcas de agua a documentos PDF",
      description: "Agrega fácilmente marcas de agua de texto o imagen a tus archivos PDF para branding, seguridad o propósitos profesionales."
    },
    mergePDF: {
      title: "Combinar múltiples archivos PDF",
      description: "Combina múltiples documentos PDF en un solo archivo para una organización, compartición y gestión optimizadas."
    },
    splitPDF: {
      title: "Dividir páginas PDF fácilmente",
      description: "Extrae páginas específicas de documentos PDF para crear nuevos archivos o reorganizar contenido eficientemente."
    },
  seoContent: {
  title: "Edición avanzada de texto PDF para documentos profesionales",
  paragraph1: "Nuestro avanzado editor de texto PDF ofrece capacidades de edición de texto de nivel profesional para documentos PDF. A diferencia de los editores de PDF básicos, nuestra herramienta garantiza modificaciones de texto precisas mientras preserva el posicionamiento, formato y diseño exactos de tu PDF original, proporcionando resultados de alta calidad para todos los usuarios.",
  paragraph2: "Utilizando algoritmos de vanguardia, nuestro editor de PDF extrae bloques de texto, detalles de fuentes y datos de posicionamiento con una precisión inigualable. Esto asegura que tu PDF editado mantenga la apariencia profesional e integridad del documento original, haciéndolo ideal para actualizaciones críticas.",
  paragraph3: "Perfecto para empresas, documentos legales, formularios, contratos y cualquier PDF que requiera cambios de texto sin comprometer el diseño general. Edita texto PDF en línea sin esfuerzo, ya sea para uso profesional, educativo o personal, con nuestras herramientas de edición intuitivas y potentes."
  },
    viewAllPDFTools: "Ver todas las herramientas PDF para una gestión integral de documentos"
  }
}
}