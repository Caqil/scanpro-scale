...
export default {
  metadata: {
    title: "MegaPDF - 무료 PDF 변환기, 편집기, OCR 및 PDF 잠금 해제",
    template: "%s | MegaPDF - PDF 도구",
    description: "MegaPDF로 PDF 변환, 편집, 잠금 해제, 압축, 병합, 분할 및 OCR을 수행하세요. 무료, 빠른 온라인 PDF 도구—다운로드 필요 없음.",
    keywords: "PDF 변환기, PDF 편집기, 온라인 OCR, PDF 잠금 해제, PDF 압축, PDF 병합, PDF 분할, 무료 PDF 도구, 온라인 PDF 편집기, MegaPDF"
  },
  nav: {
    tools: "도구",
    company: "회사",
  ...
  subscription: {
    ...
    success: {
      ...
      message: "MegaPDF를 구독해 주셔서 감사합니다! 이제 구독 등급의 모든 기능을 이용할 수 있습니다.",
      cta: "대시보드로 이동",
      seo: {
        title: "구독 성공적으로 활성화됨 - MegaPDF",
        description: "MegaPDF 구독이 활성화되었습니다. 지금 사용할 수 있는 모든 프리미엄 기능을 탐색해보세요."
      }
    },
    cancel: {
      title: "구독 취소됨",
  ...
  features: {
    title: "고급 PDF 도구 및 기능 | MegaPDF",
    description: "문서 관리, 변환, 편집 등을 위한 MegaPDF의 포괄적인 PDF 도구 및 기능 제품군을 살펴보세요.",

    hero: {
      title: "고급 PDF 도구 및 기능",
      description: "모든 문서 관리 요구를 충족하는 궁극의 솔루션인 MegaPDF를 만드는 포괄적인 도구 및 기능 제품군을 발견하세요."
    },
    ...
    mobile: {
      title: "MegaPDF 모바일 앱",
      description: "MegaPDF의 강력한 PDF 도구를 이동 중에도 사용하세요. 당사의 모바일 앱은 편리하고 모바일 친화적인 인터페이스에서 동일한 견고한 기능을 제공합니다.",
      feature1: {
        title: "문서 스캔 및 디지털화",
    ...
    testimonials: {
      title: "사용자들의 말",
      quote1: "MegaPDF는 우리 팀이 문서를 다루는 방식을 혁신했습니다. OCR 기능은 믿을 수 없을 정도로 정확하며, 일괄 처리는 매주 몇 시간을 절약해줍니다.",
      name1: "사라 존슨",
      title1: "운영 관리자",
      quote2: "API 통합은 매끄러웠습니다. MegaPDF를 워크플로우에 통합했으며 효율성의 차이는 엄청납니다. 지원 팀도 최고 수준입니다.",
      name2: "데이비드 첸",
      title2: "기술 리드",
      quote3: "소규모 사업주로서 합리적인 가격과 포괄적인 도구 세트는 MegaPDF를 놀라운 가치로 만듭니다. 특히 이동 중에 문서를 처리할 수 있는 모바일 앱이 정말 마음에 듭니다.",
      name3: "마리아 가르시아",
      title3: "사업주"
    }
  ...
  splitPdf: {
    ...
    faq: {
      ...
      q1: {
        ...
        answer: "당신의 개인정보와 보안을 위해 업로드 및 생성된 모든 파일은 1시간 후에 서버에서 자동으로 삭제됩니다."
      },
      q2: {
  ...
  compressPdf: {
    ...
    faq: {
      ...
      secure: {
        ...
        answer: "예, 데이터는 안전합니다. 모든 PDF 파일은 안전하게 온라인으로 처리되며 1시간 후 자동으로 삭제됩니다. Windows 또는 Linux를 사용하든, 파일은 암호화되며 공유되지 않습니다."
      },
      fileLimits: {
  ...
  fileUploader: {
    ...
    filesSecurity: "파일은 개인 정보 보호와 보안을 위해 1시간 후 자동으로 삭제됩니다."
  },
  ...
  contact: {
    ...
    faq: {
      ...
      responseTime: {
        ...
        answer: "모든 문의에 대해 영업일 기준 1-48시간 내에 답변을 드리려고 합니다. 피크 시간에는 최대 72시간이 걸릴 수 있습니다."
      },
      technicalSupport: {
  ...
  about: {
    hero: {
      title: "디지털 문서 관리 강화",
      description: "MegaPDF는 간단한 아이디어에서 태어났습니다: 문서 관리를 원활하고 효율적이며 모든 사람이 접근할 수 있게 만드는 것. 우리는 사람들이 디지털 문서와 상호작용하는 방식을 변화시킬 수 있다고 믿습니다."
    },
    story: {
      title: "우리의 이야기",
      paragraph1: "2022년에 설립된 MegaPDF는 복잡하고 직관적이지 않은 PDF 도구를 다루는 데서 오는 좌절감에서 비롯되었습니다. 기술 애호가이자 문서 관리 전문가인 우리의 창립자들은 강력하면서도 사용자 친화적인 솔루션을 만들 기회를 보았습니다.",
    ...
    team: {
      title: "우리 팀 만나기",
      description: "MegaPDF는 사용자들을 위해 가능한 최고의 PDF 도구를 만드는 데 집중하는 작고 헌신적인 팀에 의해 운영됩니다.",
      member1: {
        name: "차크라",
        role: "앱 개발 리더",
  ...
  legal: {
    ...
    dataUse: {
      title: "데이터 사용 방법",
      description: "저희는 귀하가 요청한 서비스를 제공하기 위해 파일을 처리합니다. 모든 파일은 1시간 후 자동으로 삭제됩니다."
    },
    cookies: {
      title: "쿠키 및 추적",
  ...
  faq: {
    ...
    general: {
      question1: "MegaPDF란 무엇인가요?",
      answer1: "MegaPDF는 PDF 관리 및 변환을 위한 포괄적인 온라인 플랫폼입니다. 저희 도구는 직관적인 웹 인터페이스 또는 API를 통해 PDF 문서를 변환, 편집, 병합, 분할, 압축, 보안 설정하는 데 도움을 줍니다.",
      question2: "MegaPDF를 사용하려면 계정을 만들어야 하나요?",
      answer2: "아니요, 등록 없이 기본 PDF 도구를 사용할 수 있습니다. 하지만 무료 계정을 만들면 기록 저장, 더 높은 파일 크기 제한, 추가 기능에 대한 접근과 같은 혜택을 누릴 수 있습니다.",
      question3: "MegaPDF에서 제 데이터는 안전한가요?",
      answer3: "네, 모든 파일은 암호화된 서버에서 안전하게 처리됩니다. 귀하의 파일은 제3자와 공유되지 않으며, 처리 후 1시간 이내에 서버에서 자동으로 삭제됩니다. 자세한 내용은 개인정보 보호정책을 참조하세요.",
      question4: "MegaPDF는 어떤 기기와 브라우저를 지원하나요?",
      answer4: "MegaPDF는 Chrome, Firefox, Safari, Edge를 포함한 모든 최신 브라우저에서 작동합니다. 플랫폼은 완전히 반응형이며 데스크톱, 태블릿, 모바일 기기에서 사용 가능합니다."
    },
    conversion: {
      question1: "어떤 파일 형식을 변환할 수 있나요?",
      answer1: "MegaPDF는 PDF를 Word(DOCX), Excel(XLSX), PowerPoint(PPTX), 이미지(JPG, PNG), HTML, 일반 텍스트 등 다양한 형식으로 변환할 수 있습니다. 이러한 형식을 다시 PDF로 변환할 수도 있습니다.",
  ...
  security: {
    ...
    sections: {
      ...
      temporaryStorage: {
        title: "임시 저장",
        description: "파일은 처리 후 1시간 이내에 자동 삭제됩니다. 필요한 기간 이상 문서를 보관하지 않습니다."
      },
      access: {
        title: "접근 제어",
    ...
    tabContent: {
      ...
      compliance: {
        ...
        approach: {
          title: "규정 준수 접근 방식",
          description: "MegaPDF는 개인정보 보호와 보안을 설계 단계부터 고려해 개발되었습니다. 변화하는 규정을 준수하기 위해 정기적으로 관행을 검토하고 업데이트합니다."
        },
        gdpr: {
          title: "GDPR 준수"
        },
    ...
    retention: {
      ...
      documents: {
        title: "업로드된 문서",
        description: "파일은 처리 후 1시간 이내에 서버에서 자동 삭제됩니다. 유료 플랜의 저장 기능을 명시적으로 선택하지 않는 한 문서 사본을 보관하지 않습니다."
      },
      account: {
        title: "계정 정보",
    ...
    faq: {
      dataCollection: {
        question: "MegaPDF는 어떤 개인 데이터를 수집하나요?",
      ...
      documentStorage: {
        ...
        answer: "문서는 일반적으로 처리 후 1시간 이내에 서버에서 자동 삭제됩니다. 유료 구독자는 문서 저장 옵션을 이용할 수 있지만, 이는 명시적으로 선택해야 하는 기능입니다."
      },
      thirdParty: {
  ...
  developer: {
    title: "개발자 API 문서",
    description: "MegaPDF의 강력한 PDF 도구를 RESTful API로 애플리케이션에 통합하세요",
    tabs: {
      overview: "개요",
      authentication: "인증",
      endpoints: "엔드포인트",
    ...
    authentication: {
      ...
      apiKeys: {
        title: "API 키",
        description: "MegaPDF API에 대한 모든 요청은 API 키를 사용한 인증이 필요합니다. API 키는 많은 권한을 가지므로 안전하게 보관하세요!"
      },
      howTo: {
        title: "인증 방법",
    ...
    overview: {
      ...
      intro: "MegaPDF API를 사용하면 PDF 처리 기능을 애플리케이션에 직접 통합할 수 있습니다. 간단한 RESTful 인터페이스로 PDF를 프로그래밍 방식으로 변환, 압축, 병합, 분할 및 기타 작업을 수행할 수 있습니다.",
      features: {
        title: "주요 기능",
  ...
  pricing: {
    description: "PDF 필요에 맞는 요금제를 선택하세요. MegaPDF는 무료부터 엔터프라이즈까지 유연한 가격 옵션을 제공하며, 필요한 기능을 갖추고 있습니다.",
  ...
  ocrPdf: {
    ...
    faq1Answer: '네, 데이터 보안을 매우 중요하게 생각합니다. 모든 파일 업로드 및 처리는 안전한 서버에서 이루어집니다. 파일은 1시간 후 자동으로 삭제되며, OCR 서비스를 제공하는 목적 외에는 사용하지 않습니다.',
  ...
  pdfChat: {
    title: "PDF 질문 채팅",
    description: "PDF를 업로드하고 내용에 대해 질문하세요",
    seo: {
      title: "PDF 질문 채팅 - 대화형 PDF 문서 분석",
      description: "PDF 문서를 업로드하고 자연어 질문을 통해 빠르게 답변, 요약 및 통찰력을 얻으세요.",
      keywords: "PDF 채팅, PDF 질문, PDF 분석, 문서 AI, PDF 도우미, 문서 분석"
    },
    whatYouCanAsk: {
      title: "질문 가능한 내용",
      summary: {
        title: "요약 받기",
        description: "특정 섹션이나 전체 문서에 대한 요약을 요청하세요."
      },
      find: {
        title: "정보 찾기",
        description: "문서 내 특정 정보가 어디에 있는지 물어보세요."
      },
      extract: {
        title: "핵심 포인트 추출",
        description: "핵심 포인트, 날짜, 이름 등의 중요한 정보 목록을 요청하세요."
      },
      explain: {
        title: "설명 받기",
        description: "문서에 언급된 복잡한 개념에 대한 설명을 요청하세요."
      }
    },
    faq: {
      title: "자주 묻는 질문",
      q1: {
        question: "어떤 유형의 PDF를 사용할 수 있나요?",
        answer: "텍스트 내용이 포함된 모든 PDF 파일을 사용할 수 있습니다. 시스템은 디지털 PDF에서 가장 잘 작동하지만, 읽을 수 있는 텍스트가 있는 스캔 문서도 처리할 수 있습니다."
      },
      q2: {
        question: "내 PDF 데이터는 안전한가요?",
        answer: "예, 귀하의 PDF는 안전하게 처리됩니다. 문서 내용을 영구적으로 저장하지 않으며, 모든 처리는 안전한 환경에서 이루어집니다."
      },
      q3: {
        question: "크기 제한이 있나요?",
        answer: "예, 현재 최대 파일 크기는 50MB입니다. 매우 큰 문서의 경우 더 나은 처리를 위해 작은 부분으로 나누는 것이 좋습니다."
      },
      q4: {
        question: "AI가 표와 차트를 이해하나요?",
        answer: "AI는 표에서 텍스트를 추출하고 해석할 수 있지만, 복잡한 차트나 다이어그램 이해는 제한적일 수 있습니다. 텍스트 내용에서 가장 잘 작동합니다."
      }
    },
    seoContent: {
      title: "문서 분석 강화",
      p1: "우리의 \"무엇이든 질문\" 기능은 고급 AI를 활용하여 PDF 문서에서 빠르게 통찰력을 추출할 수 있도록 도와줍니다. 연구 논문, 법률 계약서, 기술 매뉴얼 또는 텍스트가 많은 문서를 분석할 때 이 도구를 사용하면 내용을 읽는 데 시간을 들이지 않고 필요한 정보를 찾을 수 있습니다.",
      p2: "AI 어시스턴트는 질문의 맥락을 이해하고 문서에서 관련 정보를 제공할 수 있습니다. 주요 섹션을 식별하고, 내용을 요약하고, 복잡한 용어를 설명하며, 텍스트 깊숙이 묻힌 날짜, 금액 또는 조항과 같은 특정 세부 사항도 찾을 수 있습니다.",
      p3: "이 기능은 문서를 빠르게 분석해야 하는 전문가, 학술 논문을 연구하는 학생 또는 PDF에서 중요한 정보에 직접 접근하여 시간을 절약하려는 모든 사람에게 특히 유용합니다.",
      p4: "지금 PDF를 업로드하고 질문해 보세요!"
    },
    uploading: "PDF 업로드 중...",
    processing: "PDF 처리 중...",
    thinking: "처리 중...",
    send: "보내기",
    uploadPrompt: "PDF 문서 업로드",
    askPrompt: "문서에 대해 질문하기...",
    newPdf: "새 PDF",
    dropHereDesc: "PDF 파일을 여기에 드롭하거나 클릭하여 찾아보세요. 내용에 대해 질문할 수 있도록 분석하겠습니다.",
    securityNote: "파일은 안전하게 처리되며 영구적으로 저장되지 않습니다.",
    poweredBy: "OpenAI 제공",
    howItWorks: {
      title: "작동 방식",
      step1: {
        title: "PDF 업로드",
        description: "PDF 파일을 업로드 영역으로 드래그 앤 드롭하거나 클릭하여 파일을 찾습니다."
      },
      step2: {
        title: "AI가 내용 처리",
        description: "AI가 문서 전체를 빠르게 분석하여 내용과 구조를 이해합니다."
      },
      step3: {
        title: "질문하기",
        description: "문서에 대해 무엇이든 질문하고 PDF 내용에서 정확한 답변을 얻습니다."
      }
    },
  },
  removePdf: {
  ...
  terms: {
    title: "서비스 이용 약관",
    meta: {
      title: "서비스 이용 약관 | MegaPDF - PDF 도구",
      description: "MegaPDF PDF 도구의 서비스 이용 약관. 당사 서비스 이용에 대한 약관 및 조건을 읽어보세요."
    },
    lastUpdated: "최종 업데이트: 2025년 3월 18일",
    welcome: "MegaPDF에 오신 것을 환영합니다. 당사의 웹사이트, 모바일 애플리케이션 및 서비스(통칭하여 '서비스')를 사용하기 전에 본 서비스 이용 약관을 주의 깊게 읽어주시기 바랍니다.",
    sections: {
      acceptance: {
        title: "1. 약관 수락",
        content: "당사의 서비스에 접속하거나 이를 사용하는 것은 본 약관에 구속되는 것에 동의하는 것입니다. 본 약관에 동의하지 않는 경우, 당사의 서비스를 사용하지 마시기 바랍니다."
      },
      services: {
        title: "2. 서비스 설명",
        description: "MegaPDF는 PDF 문서 변환, 조작 및 최적화를 위한 도구를 제공하며, 아래를 포함하되 이에 국한되지 않습니다:",
        features: {
          feature1: "PDF를 다양한 형식(DOCX, XLSX, JPG 등)으로 변환",
          feature2: "문서를 PDF 형식으로 변환",
          feature3: "PDF 파일 압축",
          feature4: "여러 PDF 파일 병합",
          feature5: "PDF 파일을 개별 문서로 분할",
          feature6: "PDF 페이지 회전",
          feature7: "PDF 파일에 워터마크 추가",
          feature8: "기타 PDF 처리 기능"
        }
      },
      account: {
        title: "3. 계정 등록",
        registration: "3.1. 당사 서비스의 일부 기능은 계정 등록이 필요할 수 있습니다. 등록 시 정확하고 최신이며 완전한 정보를 제공하는 것에 동의합니다.",
        responsibility: "3.2. 귀하는 계정 자격 증명의 기밀성을 유지하고 귀하의 계정에서 발생하는 모든 활동에 대해 책임을 집니다.",
        security: "3.3. 귀하는 귀하의 계정의 무단 사용 또는 기타 보안 위반이 있을 경우 즉시 당사에 통지하는 것에 동의합니다."
      },
      obligations: {
        title: "4. 사용자 의무",
        lawfulUse: {
          title: "4.1. 합법적 사용.",
          description: "귀하는 당사 서비스를 합법적인 목적으로만, 그리고 본 약관에 따라 사용하기로 동의합니다. 귀하는 당사 서비스를 다음과 같이 사용하지 않기로 동의합니다:",
          restrictions: {
            restriction1: "적용 가능한 연방, 주, 지역 또는 국제 법률 또는 규정을 위반하는 방식",
            restriction2: "바이러스, 트로이 목마, 웜, 멀웨어 또는 기타 유해한 코드를 포함한 자료를 전송하는 목적",
            restriction3: "당사 또는 타인의 지적 재산권을 침해하거나 위반하는 목적"
          }
        },
        content: {
          title: "4.2. 콘텐츠 소유권 및 책임.",
          description: "귀하는 당사 서비스에 업로드한 파일의 모든 소유권을 유지합니다. 귀하는 파일의 콘텐츠와 해당 콘텐츠의 업로드, 처리, 다운로드의 합법성에 대해 전적으로 책임집니다."
        },
        sensitiveInfo: {
          title: "4.3. 민감 정보 금지.",
          description: "귀하는 사회 보장 번호, 금융 계좌 정보, 건강 정보 또는 특정 규제 보호 대상이 되는 기타 정보와 같은 민감한 개인 정보를 포함한 파일을 업로드하지 않기로 동의합니다."
        }
      },
      privacy: {
        title: "5. 개인정보 보호",
        description: {
          before: "귀하의 개인정보는 우리에게 중요합니다. 당사의 ",
          link: "개인정보 처리방침",
          after: "은 본 약관에 참조로 포함되며, 귀하에 관한 정보를 수집, 사용, 공개하는 방법을 설명합니다."
        }
      },
      intellectual: {
        title: "6. 지적 재산권",
        ownership: {
          title: "6.1. 당사의 지적 재산.",
          description: "서비스(모든 콘텐츠, 기능, 기능성 포함)는 당사, 라이선스 제공자 또는 기타 제공자가 소유하며 저작권, 상표 및 기타 지적 재산권 법률에 의해 보호됩니다."
        },
        license: {
          title: "6.2. 제한된 사용 라이선스.",
          description: "당사는 귀하의 개인적 또는 내부 비즈니스 목적을 위해 당사 서비스를 사용할 수 있는 제한된 비독점적, 양도 불가능, 취소 가능한 라이선스를 귀하에게 부여합니다."
        }
      },
      disclaimers: {
        title: "7. 면책 조항 및 책임 제한",
        asis: {
          title: "7.1. 서비스는 있는 그대로 제공.",
          description: "서비스는 있는 그대로 및 이용 가능한 상태로 제공되며, 명시적이거나 묵시적인 어떠한 보증도 없습니다. 여기에는 상품성, 특정 목적에의 적합성, 또는 비침해에 대한 묵시적 보증이 포함되지만 이에 국한되지 않습니다."
        },
        liability: {
          title: "7.2. 책임 제한.",
          description: "적용 가능한 법률이 허용하는 최대 범위 내에서, 당사 또는 당사의 계열사, 서비스 제공자, 직원, 대리인, 임원 또는 이사는 귀하의 서비스 사용 또는 사용 불능으로 인해 발생하거나 이와 관련된 어떠한 종류의 손해(직접, 간접, 특별, 부수적, 결과적 또는 징벌적 손해 포함)에 대해 어떠한 법적 이론 하에서도 책임을 지지 않습니다."
        }
      },
      termination: {
        title: "8. 기간 및 종료",
        duration: "8.1. 본 약관은 귀하가 서비스를 사용하는 동안 완전한 효력을 유지합니다.",
        rights: "8.2. 당사는 단독 재량으로 본 약관을 위반하거나 다른 서비스 사용자, 당사 또는 제3자에게 해롭다고 판단되는 행위, 또는 기타 이유로 인해 귀하의 모든 또는 일부 서비스에 대한 액세스를 통지 없이 종료하거나 일시 중단할 수 있습니다.",
        effect: "8.3. 종료 시 귀하의 서비스 사용 권한은 즉시 중단됩니다."
      },
      changes: {
        title: "9. 약관 변경",
        description: "당사는 언제든지 본 약관을 수정할 권리를 보유합니다. 중대한 변경 사항은 새로운 약관을 서비스에 게시하고 최종 업데이트 날짜를 갱신함으로써 통지됩니다. 변경 후 서비스의 지속적인 사용은 귀하가 새로운 약관을 수락했음을 의미합니다."
      },
      contact: {
        title: "10. 연락처 정보",
        description: "본 약관에 대한 질문이 있는 경우 아래로 연락해 주시기 바랍니다:",
        email: {
          label: "이메일:",
    ...
    agreement: "MegaPDF를 사용함으로써 귀하는 본 서비스 이용 약관을 읽고, 이해하고, 이에 구속되는 것에 동의했음을 인정합니다.",
    viewPrivacyPolicy: "개인정보 처리방침 보기"
  },
  privacy: {
    title: "개인정보 처리방침",
    meta: {
      title: "개인정보 처리방침 | MegaPDF - PDF 도구",
      description: "MegaPDF PDF 도구의 개인정보 처리방침. 우리가 귀하의 데이터를 어떻게 처리하고 귀하의 개인정보를 보호하는지 알아보세요."
    },
    lastUpdated: "최종 업데이트: 2025년 3월 18일",
    introduction: "이 개인정보 처리방침은 MegaPDF가 귀하가 당사의 웹사이트, 모바일 애플리케이션 및 서비스(총칭하여 '서비스')를 사용할 때 정보를 수집, 사용, 공개하는 방법을 설명합니다.",
    sections: {
      informationWeCollect: {
        title: "1. 우리가 수집하는 정보",
        description: "우리는 서비스 사용자로부터 및 사용자에 대해 여러 유형의 정보를 수집합니다:"
      },
      informationYouProvide: {
        title: "1.1. 귀하가 제공하는 정보",
        account: {
          label: "계정 정보:",
          description: "계정을 등록할 때 귀하의 이름, 이메일 주소, 비밀번호를 수집합니다."
        },
        payment: {
          label: "결제 정보:",
          description: "프리미엄 서비스를 구매하는 경우, 신용카드 세부 정보, 청구지 주소 및 기타 금융 정보를 포함할 수 있는 결제 정보를 수집합니다. 결제 처리는 당사의 제3자 결제 처리업체가 처리하며, 당사의 서버에는 완전한 신용카드 정보를 저장하지 않습니다."
        },
        files: {
          label: "파일 및 콘텐츠:",
          description: "우리는 귀하가 처리하기 위해 서비스에 업로드하는 파일(PDF 및 기타 문서 등)을 수집합니다."
        },
        communications: {
          label: "커뮤니케이션:",
          description: "귀하가 직접 연락하는 경우, 귀하의 커뮤니케이션에 대한 정보와 귀하가 제공하는 추가 정보를 수집할 수 있습니다."
        }
      },
      automaticInformation: {
        title: "1.2. 자동으로 수집하는 정보",
        usage: {
          label: "사용 데이터:",
          description: "우리는 귀하가 서비스와 상호작용하는 방식에 대한 정보를 수집합니다. 여기에는 사용한 기능, 서비스에서 보낸 시간, 방문한 페이지가 포함됩니다."
        },
        device: {
          label: "장치 및 연결 정보:",
          description: "우리는 귀하의 장치 및 인터넷 연결에 대한 정보를 수집합니다. 여기에는 IP 주소, 브라우저 유형, 운영 체제, 장치 식별자가 포함됩니다."
        },
        cookies: {
          label: "쿠키 및 유사 기술:",
          description: "우리는 서비스 활동을 추적하고 특정 정보를 유지하기 위해 쿠키 및 유사 추적 기술을 사용합니다. 쿠키 사용에 대한 자세한 내용은 아래 섹션 5를 참조하십시오."
        }
      },
      howWeUse: {
        title: "2. 귀하의 정보를 사용하는 방법",
        description: "우리는 수집한 정보를 다양한 목적으로 사용합니다. 포함된 목적은 다음과 같습니다:",
        purposes: {
          purpose1: "서비스를 제공, 유지, 개선하기",
          purpose2: "거래를 처리 및 완료하고 확인서를 포함한 관련 정보를 보내기",
          purpose3: "업데이트, 보안 경고, 지원 메시지와 같은 관리 정보를 보내기",
          purpose4: "귀하의 의견, 질문, 요청에 응답하고 고객 서비스를 제공하기",
          purpose5: "제품, 서비스, 제안, 프로모션, 이벤트에 대해 귀하와 소통하기",
          purpose6: "서비스와 관련된 트렌드, 사용, 활동을 모니터링하고 분석하기",
          purpose7: "사기 거래 및 기타 불법 활동을 탐지, 조사, 방지하기",
          purpose8: "서비스에서 귀하의 경험을 개인화하고 개선하기"
        }
      },
      fileHandling: {
        title: "3. 귀하의 파일을 처리하는 방법",
        processing: {
          title: "3.1. 파일 처리",
          description: "귀하가 서비스에 업로드한 파일은 요청된 변환 또는 조작 기능을 제공하기 위해 당사 서버에서 처리됩니다. 이 처리는 일반적으로 자동화되어 있으며 귀하의 콘텐츠에 대한 인간의 검토를 포함하지 않습니다."
        },
        storage: {
          title: "3.2. 파일 저장 및 보존",
          temporary: {
            label: "임시 저장:",
            description: "업로드된 파일은 서비스를 제공하기 위해 당사 서버에 임시로 저장됩니다. 프리미엄 사용자가 확장 저장 옵션을 가지지 않는 한, 파일은 24시간 후 자동으로 삭제됩니다."
          },
          converted: {
            label: "변환된 파일:",
            description: "변환 또는 처리된 결과 파일도 임시로 저장되며, 24시간 동안 다운로드 가능하며, 이후 자동으로 삭제됩니다."
          }
        },
        security: {
          title: "3.3. 파일 보안",
          description: "우리는 귀하의 파일을 무단 액세스, 공개, 변경 또는 파괴로부터 보호하기 위해 설계된 합리적인 보안 조치를 시행합니다. 그러나 인터넷을 통한 전송 방법이나 전자 저장 방법은 100% 안전하지 않음을 유의하십시오."
        }
      },
      sharing: {
        title: "4. 정보 공유",
        description: "우리는 다음과 같이 정보를 공유할 수 있습니다:",
        serviceProviders: {
          title: "4.1. 서비스 제공자",
          description: "우리는 결제 처리, 데이터 분석, 이메일 배달, 호스팅 서비스, 고객 서비스 등 당사를 대신하여 서비스를 수행하는 제3자 공급업체, 서비스 제공자, 계약자 또는 대리인과 귀하의 정보를 공유할 수 있습니다."
        },
        businessTransfers: {
          title: "4.2. 사업 이전",
          description: "우리가 합병, 인수, 자금 조달, 재구성, 파산 또는 회사 자산 매각에 관여하는 경우, 귀하의 정보는 해당 거래의 일부로 이전될 수 있습니다."
        },
        legal: {
          title: "4.3. 법적 요구사항",
          description: "법률에 의해 요구되거나 공공 기관(예: 법원 또는 정부 기관)의 유효한 요청에 응답하여 귀하의 정보를 공개할 수 있습니다."
        }
      },
      cookies: {
        title: "5. 쿠키 및 추적 기술",
        types: {
          title: "5.1. 우리가 사용하는 쿠키 유형",
          essential: {
            label: "필수 쿠키:",
            description: "이 쿠키는 서비스가 올바르게 작동하는 데 필요합니다."
          },
          analytics: {
            label: "분석 쿠키:",
            description: "우리는 사용자가 서비스와 상호작용하는 방식을 분석하여 기능과 사용자 경험을 개선하는 데 도움이 되는 쿠키를 사용합니다."
          },
          preference: {
            label: "선호 쿠키:",
            description: "이 쿠키는 귀하가 선호하는 언어나 지역과 같이 서비스의 동작이나 외관을 변경하는 정보를 기억할 수 있게 합니다."
          }
        }
      },
      rights: {
        title: "6. 귀하의 권리와 선택",
        description: "귀하의 위치에 따라 귀하의 개인 정보에 대해 특정 권리를 가질 수 있습니다:",
        options: {
          option1: "귀하의 개인 정보에 대한 액세스를 요청하기",
          option2: "부정확한 정보의 수정을 요청하기",
          option3: "귀하의 정보 삭제를 요청하기",
          option4: "우리의 정보 처리에 반대하기",
          option5: "처리 제한을 요청하기",
          option6: "데이터 이동성을 요청하기",
          option7: "처리가 동의에 기반한 경우 언제든지 동의를 철회하기"
        }
      },
      contact: {
        title: "7. 연락처 정보",
        description: "이 개인정보 처리방침 또는 당사의 데이터 관행에 대해 질문이나 우려가 있는 경우, 다음으로 연락해 주세요:",
        email: {
          label: "이메일:",
    ...
    acknowledgment: "MegaPDF를 사용함으로써 귀하는 이 개인정보 처리방침을 읽고 이해했음을 인정합니다.",
    viewTerms: "서비스 약관 보기"
},
cookies: {
  title: "쿠키 정책",
  ...
  overview: "개요",
  intro: "이 쿠키 정책은 쿠키가 무엇인지, 그리고 우리가 웹사이트에서 쿠키를 어떻게 사용하는지를 설명합니다. 쿠키가 무엇인지, 우리가 어떻게 사용하는지, 사용하는 쿠키의 유형, 그리고 쿠키 설정을 관리하는 방법을 이해하기 위해 이 정책을 읽어보시길 권장합니다.",
  ...
  whatAre: {
    title: "쿠키란 무엇인가?",
    description: "쿠키는 웹사이트를 방문할 때 컴퓨터나 모바일 장치에 저장되는 작은 텍스트 파일입니다. 웹사이트를 더 효율적으로 작동하게 하고 웹사이트 소유자에게 정보를 제공하기 위해 널리 사용됩니다.",
    purpose: "쿠키는 사용자의 장치를 인식하여 개인화된 경험을 제공하는 데 사용됩니다. 또한 계정의 보안을 보장하고, 서비스 사용을 분석하며, 마케팅 활동을 지원하는 데 사용됩니다."
  },
  
  types: {
    title: "우리가 사용하는 쿠키의 유형",
    essential: {
      title: "필수 쿠키",
      description: "이 쿠키는 웹사이트가 정상적으로 작동하는 데 필요합니다. 페이지 탐색 및 웹사이트의 보안 영역에 대한 접근과 같은 기본 기능을 활성화합니다. 이 쿠키가 없으면 웹사이트가 제대로 작동하지 않습니다.",
      examples: {
        session: "인증을 위한 세션 쿠키",
        csrf: "보안을 위한 CSRF 토큰",
        load: "부하 분산 쿠키"
      }
    },
    functional: {
      title: "기능 쿠키",
      description: "이 쿠키는 웹사이트가 향상된 기능과 개인화를 제공할 수 있도록 합니다. 이는 우리 또는 우리가 페이지에 추가한 서비스를 제공하는 제3자 제공자에 의해 설정될 수 있습니다.",
      examples: {
        language: "언어 선호도 쿠키",
        theme: "사용자 인터페이스 사용자 정의 쿠키"
      }
    },
    analytics: {
      title: "분석 쿠키",
      description: "이 쿠키는 방문자가 웹사이트와 어떻게 상호작용하는지를 이해하는 데 도움을 줍니다. 방문자 수, 이탈률, 트래픽 소스 등과 같은 메트릭에 대한 정보를 제공합니다.",
      examples: {
        ga: "구글 애널리틱스 쿠키",
        heatmap: "사용자 행동 추적 쿠키"
      }
    },
    advertising: {
      title: "광고 쿠키",
      description: "이 쿠키는 웹사이트 간 방문자를 추적하는 데 사용됩니다. 개별 사용자에게 관련성 있고 매력적인 광고를 표시하여 퍼블리셔와 제3자 광고주에게 더 가치 있는 광고를 제공하는 것이 목적입니다."
    }
  },
  
  howWeUse: {
    title: "쿠키 사용 방법",
    description: "우리는 다양한 이유로 쿠키를 사용하며, 그 이유는 다음과 같습니다:",
    purposes: {
      authentication: "사용자를 인증하고 사용자 계정의 부정 사용을 방지하기 위해",
      security: "서비스의 보안을 강화하기 위해",
      preferences: "사용자의 선호도 및 설정에 대한 정보를 기억하기 위해",
      analytics: "웹사이트 사용 방법을 이해하여 기능과 사용자 경험을 개선하기 위해",
      features: "서비스의 특정 기능과 기능을 활성화하기 위해"
    }
  },
  
  thirdParty: {
    title: "제3자 쿠키",
    description: "우리의 자체 쿠키 외에도 사용 통계 보고, 광고 전달 등을 위해 다양한 제3자 쿠키를 사용할 수 있습니다.",
    providers: {
      analytics: "가장 자주 방문하는 페이지를 포함하여 웹사이트 사용 방법에 대한 정보를 수집하는 데 사용됩니다. 이 정보를 사용하여 웹사이트와 서비스를 개선합니다.",
      payment: "플랫폼에서의 구독 및 구매를 위한 결제 처리와 사기 방지에 사용됩니다.",
      heatmap: "히트맵과 세션 녹화를 통해 사용자가 페이지의 다양한 요소와 어떻게 상호작용하는지를 이해하는 데 사용됩니다."
    }
  },
  
  manage: {
    title: "쿠키 설정 관리",
    description: "대부분의 웹 브라우저는 설정을 통해 쿠키를 제어할 수 있습니다. 그러나 웹사이트가 쿠키를 설정하는 기능을 제한하면 전체 사용자 경험이 영향을 받을 수 있으며, 웹사이트의 특정 기능이 의도한 대로 작동하지 않을 수 있습니다.",
    browser: {
      title: "브라우저 제어",
      description: "브라우저 설정을 통해 쿠키를 관리할 수 있습니다. 인기 있는 브라우저에서 이를 수행하는 방법은 다음과 같습니다:",
      chrome: "설정 > 개인정보 및 보안 > 쿠키 및 기타 사이트 데이터",
      firefox: "옵션 > 개인정보 및 보안 > 쿠키 및 사이트 데이터",
      safari: "환경설정 > 개인정보 > 쿠키 및 웹사이트 데이터",
      edge: "설정 > 쿠키 및 사이트 권한 > 쿠키 및 사이트 데이터"
    },
    warning: "필수 쿠키를 비활성화하면 웹사이트의 기능에 영향을 미치며, 일부 기능이 제대로 작동하지 않을 수 있습니다."
  },
